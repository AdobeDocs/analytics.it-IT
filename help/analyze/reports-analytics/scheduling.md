...
| Contenuto rapporto | <ul><li>Numero di righe nella tabella: Specifica il numero di righe che si desidera visualizzare nella tabella del rapporto inviato.</li><li>Lingua per intestazione e piè di pagina: Specifica la lingua dell’intestazione e del piè di pagina.</li><li>Commenti: Specifica il testo che viene visualizzato all'inizio del rapporto.</li></ul> |
...
1. Selezionate il formato desiderato per il rapporto:
   ...
   * **[!UICONTROL CSV]**: Specifica che il rapporto verrà scaricato in [!DNL .csv] (formato di valori separati da virgola).
