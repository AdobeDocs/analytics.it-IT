...
1. Genera un report, ad esempio un [!UICONTROL Pages Report] ( **[!UICONTROL Reports]** > **[!UICONTROL Site Content]** > **[!UICONTROL Pages]**).
...
La maggior parte dei rapporti Conversione e Traffico dispone di una vista con tendenze disponibile. Utilizzo della [!UICONTROL Calendar], puoi mostrare miglioramenti per qualsiasi suddivisione del periodo di tempo, compresi giorni di un mese, settimane di un anno, settimane di un trimestre, mesi di un anno e così via. I rapporti con tendenze mostrano le tendenze per una singola metrica (ricavi, ordini, visualizzazioni e così via) fino a cinque elementi (come prodotti, categorie, pagine web e così via).

**Per eseguire un rapporto con tendenze**

1. Eseguire un rapporto di conversione o di traffico, ad esempio **[!UICONTROL Reports]** > **[!UICONTROL Site Content]** > **[!UICONTROL Pages]**.
...
La [!UICONTROL Fallout Report] mostra il numero di visitatori che hanno visitato una sequenza di pagine predefinite. Mostra anche i tassi di conversione e di abbandono tra ciascun passaggio.

Dai un&#39;occhiata al nuovo [Analisi abbandono](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow.html?lang=it) pannello in Analysis Workspace!
...
1. Sulla [!UICONTROL Define Checkpoints] Specifica i punti di controllo da utilizzare per il rapporto.
...
Consulta la sezione [Visualizzazione a flusso](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/fallout/fallout-flow.html) in Analysis Workspace!
...
Consulta la sezione [Canale di marketing](/help/components/c-marketing-channels/analyze-mc.md) sistema di assistenza per ulteriori informazioni.

## Eseguire un rapporto di rilevamento delle anomalie {#task_4808C96327354D789C075823F5C3A049}

Puoi eseguire [Rilevamento delle anomalie e Analisi del contributo](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/virtual-analyst/anomaly-detection/anomaly-detection.html?lang=it) solo in Analysis Workspace.
...
Vedi [Panoramica dei rapporti in tempo reale](/help/components/c-real-time-reporting/realtime.md) per ulteriori informazioni.

1. Dai un&#39;occhiata al **[!UICONTROL Overview]** e relativi componenti:  ![](assets/rtr_overview_report.png)
...
2. Fai clic su una voce di elenco nel Reportlet principale per avviare il **[!UICONTROL Details]** visualizza la voce dell&#39;elenco:  ![](assets/rtr_detail_report.png)
