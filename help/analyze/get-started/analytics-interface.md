...
Utilizza il [!UICONTROL **Rapporti**] area nella barra a sinistra sulla [!UICONTROL **Workspace**] scheda. Per ulteriori informazioni, consulta *Passare alla scheda Rapporti* nella [pagina di destinazione di Adobe Analytics](/help/analyze/landing.md).
