...
title: Interfaccia di Analytics
...
2. Seleziona una delle seguenti funzioni del prodotto per configurarla:
   ...
   | Pagina principale degli strumenti di amministrazione | L’area Strumenti di amministrazione di Analytics è l’area principale in cui gestire l’istanza di Adobe Analytics e in cui è possibile eseguire la maggior parte delle attività amministrative. | [Panoramica degli strumenti di amministrazione](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/c-admin-tools.html?lang=en) |
