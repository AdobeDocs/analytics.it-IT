...
Per un video demo, vedi ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Confronto degli strumenti](https://video.tv.adobe.com/v/329303?captions=ita&quality=12&learn=on){target="_blank"}.
...
**[API di inserimento dati in blocco](https://developer.adobe.com/analytics-collection-apis/methods/bulk-data-insertion/)**
...
* Se acquisisci dati del cliente di livello Enterprise in un database CRM (Customer Relationship Management) e vuoi caricarli in CX Enterprise.
