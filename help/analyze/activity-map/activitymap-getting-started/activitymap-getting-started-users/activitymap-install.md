...
* Supporta le **[!UICONTROL Remember my login]** funzionalità.
* **Può iniettare** la barra degli strumenti di Activity Map nelle pagine web che non contengono codice pagina di Analytics. Visualizza un messaggio di errore se la pagina non contiene il codice della pagina di Analytics.
...
1. Risposta **[!UICONTROL Yes]** quando viene richiesto se si desidera scaricare il plug-in browser di Activity Map.
1. Una volta completato il download, trova il percorso del file .zip e decomprimi il contenuto.
1. Torna alla barra degli indirizzi di Chrome e inserisci `chrome://extensions`.
...
1. Se viene visualizzata un’icona Adobe Analytics  ![](assets/an_icon.png){width="70px"} aggiunto alla barra degli strumenti, il download è stato eseguito correttamente. Ora puoi [launch Activity Map](/help/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-launch.md) dalla pagina.
...
1. Fai clic sul pulsante **[!UICONTROL Open Menu]** in alto a destra e seleziona **[!UICONTROL Add-Ons]**. ![](assets/firefox_install3.png){width="250px"}
1. Activity Map deve essere elencato come uno dei componenti aggiuntivi Firefox.
1. Se viene visualizzata un’icona Adobe Analytics  ![](assets/an_icon.png) aggiunto alla barra degli strumenti, il download è stato eseguito correttamente. Ora puoi [launch Activity Map](/help/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-launch.md) dalla pagina.
