...
| [!UICONTROL Publishing Options] | In questa colonna verrà elencato il Power BI se è selezionata una delle [opzioni di pubblicazione del Power BI](https://experienceleague.adobe.com/docs/analytics/analyze/legacy-report-builder/publish-powerbi/power-bi.html?lang=it). |
