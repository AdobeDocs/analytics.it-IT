...
1. Attiva annotazioni. Per attivare le annotazioni, vedi [Attivare o disattivare le annotazioni](overview.md#on-off).
...
| Data | Aspetto |
| --- | --- |
| **Giorno singolo** | <img src="assets/single-day-mobile-annotations.png"  width="50%"><br></br> |
| **Intervallo date** | <img src="assets/date-range.png"  width="50%"> |
| **Annotazioni sovrapposte** | <img src="assets/overlapping-annotations.png"  width="50%"><br></br>Per visualizzare i dettagli delle annotazioni nell’app delle dashboard di Analytics, tocca un’icona di annotazione. <br></br>Quando visualizzi un’annotazione in un grafico, puoi scorrere verso sinistra e destra per spostarti tra le annotazioni presenti nel grafico. Quando visualizzi un’annotazione nella tabella, scorri verso sinistra e verso destra per spostarti tra le annotazioni associate a tale elemento nella tabella. <br></br><img src="assets/swipe-multiple-annotations.png"  width="50%"> <br></br>Nei grafici che non hanno una base temporale *asse x*, ad esempio i grafici ad anello o a barre orizzontali, per visualizzare le annotazioni applicabili al grafico, tocca l’icona situata nell’angolo in basso a destra.<br></br> <img src="assets/charts-without-timebase.png"  width="50%"> |
