...
1. Per creare le annotazioni sono disponibili 4 modi per iniziare:
   ...
   * Vai a [!UICONTROL Analytics] > [!UICONTROL Components] > [!UICONTROL Annotation]. Viene visualizzata la pagina Gestione annotazioni. Fai clic su [!UICONTROL Create New Annotation] e si apre il Generatore di annotazioni, oppure

   * Fare clic con il pulsante destro del mouse su un punto di una tabella o di un grafico a linee. Viene aperto il Generatore di annotazioni, oppure

   * In Workspace, vai a [!UICONTROL Components] > [!UICONTROL Create annotation].
