...
Le selezioni di calendario sono applicabili a livello del singolo pannello, ma è possibile applicarle a tutti i pannelli. Quando fai clic su un intervallo di date in Workspace, l&#39;interfaccia visualizza il mese del calendario corrente e il mese del calendario precedente. È possibile regolare questi due calendari facendo clic sulle frecce destra e sinistra in ciascun rispettivo angolo superiore.

![Calendario      ](assets/aw_calendar.png)

Il primo clic su un calendario avvia una selezione di intervalli di date. Con un secondo clic viene completato un intervallo di date, che viene evidenziato. Se il `Shift` tasto è tenuto premuto (o se si fa clic con il pulsante destro del mouse), viene aggiunto all’intervallo attualmente selezionato.
