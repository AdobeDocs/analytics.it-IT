...
|  | Consenti alle anomalie di ridimensionare l’asse Y | Se in un grafico sono presenti più metriche, è necessario passare il cursore sopra ogni anomalia per visualizzare la banda di affidabilità per tale metrica. Per rendere la visualizzazione più leggibile, l’intervallo di affidabilità del rilevamento delle anomalie non ridimensiona automaticamente l’asse y. Questa opzione consente all’intervallo di attendibilità di ridimensionare la visualizzazione. <p>Per ulteriori informazioni, consulta [Visualizzare le anomalie in Analysis Workspace](/help/analyze/analysis-workspace/virtual-analyst/c-anomaly-detection/view-anomalies.md).</p> |
...
| **Grafici sovrapposti** |  |  |
|  | 100% in pila | Applicata alle visualizzazioni Superfici sovrapposte, Barre sovrapposte o Barre orizzontali sovrapposte, questa impostazione converte il grafico in una visualizzazione con sovrapposizione 100%.  <p>Per ulteriori informazioni, consulta [Barre e barre sovrapposte](/help/analyze/analysis-workspace/visualizations/bar.md).</p> |
| **[Istogramma](/help/analyze/analysis-workspace/visualizations/histogram.md)** |  |  |
|  | Numero di bucket | Scegli il numero di intervalli di dati (bucket) nella visualizzazione. Il numero massimo consentito è 50. <p>Per ulteriori informazioni, consulta [Istogramma](/help/analyze/analysis-workspace/visualizations/histogram.md).</p> |
...
>[!AVAILABILITY]
>
>La funzionalità Collegamenti ad accesso pubblico descritta in questa sezione si trova nella fase di prova limitata del rilascio. Questa nota verrà rimossa quando la funzionalità è generalmente disponibile. Per informazioni sul processo di rilascio di Analytics, vedi [Versioni delle funzioni di Adobe Analytics](/help/release-notes/releases.md).
...
|  | Disattiva tutti i collegamenti di accesso pubblico | <p>Impedisce agli utenti della tua organizzazione di condividere progetti Analysis Workspace con persone che non dispongono di un account Analysis Workspace. Gli utenti possono condividere i progetti solo con altri utenti Analysis Workspace all’interno della tua organizzazione.</p> <p>Quando i collegamenti pubblici sono disattivati:</p> <ul><li><p>Gli utenti non possono creare collegamenti di accesso pubblico</p><p>L&#39;opzione &quot;Condividi collegamento pubblico&quot; viene rimossa dal menu Condividi . Ciò significa che gli utenti non possono più condividere progetti con persone che non dispongono di un account Analysis Workspace nella tua organizzazione come descritto in [Condividi un collegamento pubblico con chiunque (non è richiesto l’accesso)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Condividere progetti](/help/analyze/analysis-workspace/curate-share/share-projects.md).</p></li> <li><p>Tutti i collegamenti pubblici esistenti sono disabilitati</p></li><p>Se i collegamenti pubblici sono disattivati e quindi riattivati, tutti i collegamenti precedentemente disattivati non vengono riattivati automaticamente. In questo caso, gli utenti devono riattivarli manualmente per ogni progetto dalla finestra di dialogo Condividi progetto .</p> |
|  | Richiedi password | <p>Applica agli utenti della tua organizzazione la protezione tramite password quando creano collegamenti pubblici.</p> <p>Dopo aver abilitato questa opzione, ogni volta che un utente crea un collegamento pubblico a un progetto Analysis Workspace, l’opzione &quot;Richiedi password&quot; viene abilitata nella finestra di dialogo di condivisione e non può essere disabilitata dall’utente. (Per informazioni su come gli utenti possono condividere progetti con utenti esterni all’organizzazione, consulta [Condividi un collegamento pubblico con chiunque (non è richiesto l’accesso)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Condividere progetti](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Quando abiliti questa opzione, considera quanto segue:</p> <ul><li><p>Quando abiliti questa opzione, tutti i collegamenti pubblici attualmente attivi per i quali non è abilitata la protezione tramite password vengono disattivati.</p></li> <li><p>Se questa opzione è attivata e successivamente disattivata, tutti i collegamenti precedentemente disattivati non vengono riattivati automaticamente. In questo caso, gli utenti devono riattivarli manualmente dalla finestra di dialogo Condividi progetto .</p></li></ul> |
|  | Richiedi autenticazione single sign-on | <p>Richiede autenticazione single sign-on (SSO) per tutti i collegamenti pubblici. Quando questa opzione è abilitata, solo i destinatari che hanno un ID federato e possono accedere ad Experience Cloud possono accedere ai collegamenti pubblici condivisi.</p> <p>Dopo aver abilitato questa opzione, ogni volta che un utente crea un collegamento a un progetto Analysis Workspace, l’opzione &quot;Richiedi autenticazione single sign-on (SSO)&quot; viene abilitata nella finestra di dialogo di condivisione e non può essere disabilitata dall’utente. (Per informazioni su come gli utenti possono condividere progetti con utenti esterni all’organizzazione, consulta [Condividi un collegamento pubblico con chiunque (non è richiesto l’accesso)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Condividere progetti](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p> <p>Quando abiliti questa opzione, considera quanto segue:</p><ul><li><p>Quando abiliti questa opzione, tutti i collegamenti pubblici attualmente attivi privi di SSO attivati vengono disattivati.</p></li> <li><p>Se questa opzione è attivata e successivamente disattivata, tutti i collegamenti precedentemente disattivati non vengono riattivati automaticamente. In questo caso, gli utenti devono riattivarli manualmente dalla finestra di dialogo Condividi progetto .</p></li> <li><p>Questa opzione è disponibile solo se l’SSO è implementato nell’organizzazione. Per informazioni su come gli amministratori di sistema possono abilitare SSO per la tua organizzazione, vedi [Impostazione dell&#39;identità e del Single Sign-On](https://helpx.adobe.com/it/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Se l’SSO è configurato per la tua organizzazione, controlla se nella console è implementato un qualsiasi tipo di creazione automatica dell’account. In genere, un amministratore di sistema lo configura, come descritto in [Attiva creazione account automatica](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Se l’organizzazione si trova in un settore che richiede la conformità HIPAA, questa opzione viene abilitata automaticamente e non può essere disabilitata.</p></li></ul> |
|  | Visualizza l&#39;opzione &quot;Richiedi autenticazione single sign-on&quot; agli utenti | <p>Se l’opzione &quot;Richiedi autenticazione single sign-on&quot; è disabilitata, puoi selezionare questa opzione per consentire agli utenti della tua organizzazione di scegliere se richiedere l’autenticazione single sign-on per i progetti condivisi. In questo caso, ogni volta che un utente crea un collegamento a un progetto Analysis Workspace, l’opzione &quot;Richiedi autenticazione single sign-on (SSO)&quot; viene abilitata nella finestra di dialogo di condivisione. Gli utenti possono disattivarlo se lo desiderano.<!--or is this disabled by default?--> (Per informazioni su come gli utenti possono condividere progetti con utenti esterni all’organizzazione, consulta [Condividi un collegamento pubblico con chiunque (non è richiesto l’accesso)](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-public-link) in [Condividere progetti](/help/analyze/analysis-workspace/curate-share/share-projects.md).)</p><p>Se l’opzione &quot;Richiedi autenticazione single sign-on&quot; è abilitata, questa opzione per visualizzarla agli utenti è selezionata e non può essere deselezionata.</p><p>Quando selezioni questa opzione, tieni presente quanto segue:</p><ul><li><p>Questa opzione è disponibile solo se l’SSO è implementato nell’organizzazione. Per informazioni su come gli amministratori di sistema possono abilitare SSO per la tua organizzazione, vedi [Impostazione dell&#39;identità e del Single Sign-On](https://helpx.adobe.com/it/enterprise/using/set-up-identity.html){target=_blank}.</p><p>Se l’SSO è configurato per la tua organizzazione, controlla se nella console è implementato un qualsiasi tipo di creazione automatica dell’account. In genere, un amministratore di sistema lo configura, come descritto in [Attiva creazione account automatica](https://helpx.adobe.com/enterprise/using/automatic-account-creation.html){target=_blank}.</p></li><li><p>Se selezioni questa opzione e un utente sceglie di richiedere l’autenticazione single sign-on, solo i destinatari che hanno un ID federato e possono accedere ad Experience Cloud possono accedere ai collegamenti pubblici condivisi.</p></li></ul> |
