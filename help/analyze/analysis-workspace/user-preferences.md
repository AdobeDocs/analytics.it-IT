...
| | Mostra descrizioni comandi | Determina se visualizzare le descrizioni comandi contenenti i dati dei nodi quando si passa il puntatore sui singoli nodi all’interno di una visualizzazione del flusso. |
