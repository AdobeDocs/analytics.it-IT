...
| [!UICONTROL Type] | Indica se questa voce è un progetto Workspace, una cartella o una [scorecard per dispositivi mobili](https://experienceleague.adobe.com/en/docs/analytics/analyze/mobapp/home). |
