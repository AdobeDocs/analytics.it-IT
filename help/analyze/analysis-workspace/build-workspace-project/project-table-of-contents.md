...
1. Nel pannello del pulsante, seleziona ![ViewList](/help/assets/icons/ViewList.svg) **[!UICONTROL Table of contents]**. Per ulteriori informazioni, consulta [Panoramica su Analysis Workspace](/help/analyze/analysis-workspace/home.md).<br/>
...
See ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Table of contents](https://experienceleague.adobe.com/it/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/create-a-toc-in-analysis-workspace){target="_blank"} for a demo video.
