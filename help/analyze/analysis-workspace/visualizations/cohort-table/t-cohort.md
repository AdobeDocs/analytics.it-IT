...
Come altre visualizzazioni in Analysis Workspace, puoi scaricare una visualizzazione per coorte come file CSV o PDF. Per ulteriori informazioni, vedere [Scaricare file PDF o CSV](/help/analyze/analysis-workspace/curate-share/download-send.md).
