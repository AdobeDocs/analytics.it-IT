...
1. (Facoltativo) Regolare il **[!UICONTROL Cohort Table Settings]** facendo clic sull’icona a forma di ingranaggio.
...
Come altre visualizzazioni in Analysis Workspace, puoi scaricare una visualizzazione per coorte come file CSV o PDF. Per ulteriori informazioni, consulta [Scaricare file PDF o CSV](/help/analyze/analysis-workspace/curate-share/download-send.md).
