...
1. Definisci il **[!UICONTROL Inclusion Criteria]** (Criteri di inclusione), **[!UICONTROL Return Criteria]** (Criteri di ritorno) **[!UICONTROL Cohort Type]** (Tipo di coorte) e **[!UICONTROL Settings]** (Impostazioni) come definito nella tabella seguente.
...
1. In [Segment Builder](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html) (Generatore di segmenti), modifica ulteriormente il segmento, quindi fai clic su **[!UICONTROL Save]** (Salva).
