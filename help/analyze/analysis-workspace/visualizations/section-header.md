...
_In questo articolo viene documentata la visualizzazione dell&#39;intestazione di sezione in_ ![AdobeAnalytics](/help/assets/icons/AdobeAnalytics.svg) _**Adobe Analytics**._<br/>_Vedere [Intestazione di sezione](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/section-header) per la_ ![CustomerJourneyAnalytics](/help/assets/icons/CustomerJourneyAnalytics.svg) _**Customer Journey Analytics** versione di questo articolo._
...
![Intestazione di sezione](/help/analyze/analysis-workspace/visualizations/assets/section-header.png)
