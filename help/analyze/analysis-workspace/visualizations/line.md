...
>[!IMPORTANT]
>
> Alcune impostazioni di visualizzazione Linea, come Aggiungi linea di tendenza, sono attualmente in fase di test limitati. [Ulteriori informazioni](https://docs.adobe.com/content/help/it-IT/analytics/landing/an-releases.html).
...
### Aggiunta di una sovrapposizione di tendenza

In Impostazioni **visualizzazione > Overlays > Add trendline (Sovrapposizioni)**, puoi scegliere di aggiungere una tendenza di regressione alla serie di linee. Le linee di tendenza consentono di rappresentare un pattern più chiaro nei dati.
