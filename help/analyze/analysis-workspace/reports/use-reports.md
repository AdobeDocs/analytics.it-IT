...
# Utilizzare rapporti predefiniti

I rapporti predefiniti in Analysis Workspace forniscono informazioni rapide sugli scenari di reporting più comuni. Di seguito sono riportati alcuni esempi di domande a cui è possibile rispondere con i rapporti predefiniti:
...
Le informazioni seguenti descrivono come accedere e utilizzare i rapporti predefiniti dalla scheda [!UICONTROL Reports] in Analysis Workspace.

## Accedere ad un rapporto ed eseguirlo

1. In Analysis Workspace, seleziona la scheda [!UICONTROL **Workspace**].

1. Seleziona [!UICONTROL **Rapporti**].

   ![Scheda Rapporti](assets/view-prebuilt-reports.png)

1. Nel campo di ricerca, inizia a digitare il nome del rapporto che desideri trovare, quindi selezionalo dall’elenco dei rapporti. È possibile anche effettuare una ricerca nell’elenco dei rapporti per proprietà, eVar e numero evento. <!-- still true? -->

   Oppure

   Seleziona la categoria di rapporti che desideri visualizzare, quindi seleziona il rapporto dal relativo elenco.

   >[!TIP]
   >
   >   Per spostarti nel menu utilizzando i tasti freccia, premi il tasto Barra obliqua (/), quindi premi il tasto Freccia giù. Premi Invio per caricare il rapporto selezionato.

Per un elenco dei rapporti disponibili, consulta la sezione [Rapporti disponibili](#available-reports) seguente.

## Salvare un rapporto {#use-reports}
...
1. (Facoltativo) Salva il rapporto come progetto selezionando [!UICONTROL **Progetto**] > [!UICONTROL **Salva**].
   ...
   Il rapporto viene salvato come nuovo progetto e non viene modificato il rapporto esistente. Per ulteriori informazioni sul salvataggio di un rapporto come progetto, consulta [Salvare i progetti](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md).

## Rapporti disponibili

La tabella seguente contiene l’elenco completo dei rapporti predefiniti disponibili.

Alcuni dei rapporti predefiniti più popolari includono Flusso, Fallout, Canale di marketing e Rapporti in tempo reale.
