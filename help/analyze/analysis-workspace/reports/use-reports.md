...
Le informazioni seguenti descrivono come accedere e utilizzare i rapporti predefiniti di [!UICONTROL Reports] in Analysis Workspace.

## Accedere ed eseguire un rapporto
...
1. Nel campo di ricerca, inizia a digitare il nome del report che desideri trovare, quindi selezionalo dall’elenco dei report. È possibile anche effettuare una ricerca nell’elenco dei rapporti per proprietà, eVar e numero evento.<!-- still true? -->

   Oppure

   Selezionare la categoria di report che si desidera visualizzare, quindi selezionare il report dall&#39;elenco dei report.

   >[!TIP]
   >
   >   Per spostarsi nel menu utilizzando i tasti di direzione, premere il tasto Barra obliqua (/), quindi premere il tasto Freccia giù. Premi Invio per caricare il rapporto selezionato.

Per un elenco dei rapporti disponibili, vedi [Rapporti disponibili](#available-reports) sezione successiva.
...
1. (Facoltativo) Salva il rapporto come progetto selezionando [!UICONTROL **Progetto**] > [!UICONTROL **Salva**].
   ...
   Il report viene salvato come nuovo progetto e non modifica il report esistente. Per ulteriori informazioni sul salvataggio di un report come progetto, consulta [Salva progetti](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md).

## Rapporti disponibili

La tabella seguente contiene l’elenco completo dei rapporti predefiniti disponibili.

Alcuni dei più popolari rapporti predefiniti includono Flusso, Abbandono, Canale di marketing e Rapporti in tempo reale.
