...
| Query simultanee | Il numero di query richieste dall&#39;organizzazione per l&#39;Adobe contemporaneamente. Ciascuna organizzazione ha diritto a un minimo di 5 query simultanee. | Se un report richiede molto tempo, in genere è dovuto al fatto che si trova in coda con altri report. Ciò significa che l’organizzazione sta tentando di eseguire molte richieste simultanee su una suite di rapporti specifica. Le query possono provenire da richieste API, interfacce di reporting (Analysis Workspace, Reports &amp; Analytics, Report Builder, ecc.), progetti pianificati, rapporti pianificati, avvisi pianificati e utenti simultanei che eseguono richieste di reporting. | Distribuisci le richieste e le pianificazioni per la suite di rapporti in modo più uniforme durante l’intera giornata. Inoltre, se possibile, sposta le tue richieste a orari fuori picco. Lunedì mattina, martedì mattina, e il primo di ogni mese sono ore di segnalazione di picco. |
