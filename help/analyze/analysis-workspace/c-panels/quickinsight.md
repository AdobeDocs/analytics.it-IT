...
*Questo articolo documenta il pannello Quick Insights in **Adobe Analytics**.<br/>Consulta [Pannello Quick Insights](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/quickinsight) per la versione di **Customer Journey Analytics**di questo articolo.*
