...
| ![Algoritmo](assets/algorithmic.png) | [Algoritmo](/help/analyze/analysis-workspace/c-panels/attribution/algorithmic.md) | (Nota: L&#39;attribuzione algoritmica è attualmente in fase di verifica limitata.) Utilizza tecniche statistiche per determinare in modo dinamico l&#39;allocazione ottimale del credito per la metrica selezionata. | Utile per evitare tentativi o euristica quando si sceglie il modello di attribuzione corretto per la propria attività. |
