...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Pannelli {#panels}
      ...
      + [Pannello Tempo di riproduzione dei contenuti multimediali](analysis-workspace/c-panels/media-playback-time-spent.md)
...
+ Dashboard di Adobe Analytics {#mobapp}
   ...
   + [Configurare i dirigenti per l’utilizzo delle scorecard](mobile-app/set-up-execs.md)
