...
Ad Hoc Analysis include funzionalità familiari per la creazione di segmenti, oltre a nuovi aggiornamenti di funzionalità come [Segment Manager](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_manage.html) utilizzati per impostare un [flusso di lavoro](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_workflow.html)di gestione segmenti. Come sempre, puoi creare e salvare segmenti nel Generatore [di](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build.html) segmenti o [generare segmenti da un rapporto](https://marketing.adobe.com/resources/help/en_US/analytics/segment/t_seg_fallout.html) di abbandono dalla console di analisi ad hoc, quindi salvare i segmenti nuovi o estesi nella libreria del pubblico per l’accesso e l’applicazione generali. ![](assets/seg__overview_ad_hoc.png)
...
* [I segmenti](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_overview.html) sono universali per tutte le suite di rapporti. Precedentemente, i segmenti erano specifici della suite di rapporti.
* Gestione [](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_manage.html) segmenti consente di impostare [flussi di lavoro](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_workflow.html) con funzioni di condivisione dei segmenti, assegnazione di tag, verifica e approvazione.

* Il Generatore di [segmenti](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_build_ui.html) è stato aggiornato per semplificare la creazione dei segmenti.
* Puoi assegnare [tag ai segmenti](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_tag.html) per organizzarli ed effettuare ricerche in un secondo momento, anziché utilizzare le cartelle. Precedentemente, per organizzare i segmenti erano state utilizzate le cartelle [!DNL ad hoc analysis].

* Puoi creare segmenti [](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_sequential.html) sequenziali all’esterno di Analisi ad hoc.
* 
...
La maggior parte dei segmenti predefiniti e suite precedenti verranno trasferiti come modelli [di](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_templates.html) segmento nel generatore di segmenti. I modelli di segmento sono utilizzati per creare rapidamente segmenti personalizzati con audience comuni. I modelli di segmento non possono essere applicati direttamente a un report, ma possono essere facilmente salvati in un segmento personalizzato.

## Cos'è successo alle cartelle dei segmenti esistenti? {#section_FB04DCF775694E69B761DCA53F301C30}

Invece delle cartelle (Analisi ad hoc), il Gestore dei segmenti utilizza [i tag](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_tag.html). I nomi delle cartelle vengono automaticamente convertiti in tag e tali tag vengono applicati ai rispettivi segmenti.
...
Gli amministratori possono modificare qualsiasi segmento, [condividere segmenti](https://marketing.adobe.com/resources/help/en_US/analytics/segment/t_seg_share.html) con gruppi e [impostare diritti](https://marketing.adobe.com/resources/help/en_US/analytics/segment/seg_rights.html) per accedere ai segmenti dell'organizzazione.
...
Se il segmento è stato [pubblicato in Experience Cloud](https://marketing.adobe.com/resources/help/en_US/mcloud/t_publish_audience_segment.html), non puoi eliminarlo o modificarlo. Tuttavia, potete copiarlo e modificare la versione copiata.
