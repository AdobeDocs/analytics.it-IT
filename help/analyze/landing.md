...
| --- | --- | --- |
| Espandi [!UICONTROL Projects] da tabella a schermo intero | Per espandere la tabella, fai clic sull’icona del menu hamburger. Questa azione comprime le schede della barra a sinistra. | ![Espandi tabella](assets/landing-collapse.png) |
| Personalizzare la larghezza della colonna | In precedenza, la larghezza della colonna era fissa. Ora è possibile regolarlo trascinando il separatore di colonna. |  |
| Riordinare gli elementi bloccati | Per spostare gli elementi fissi verso l’alto o verso il basso, fai clic sui puntini di sospensione accanto all’elemento fissato e seleziona **[!UICONTROL Move up]** o **[!UICONTROL Move down]**. | ![Sposta elementi fissi](assets/move-up-down.png) |
| Nuove colonne di tabella | Fai clic sul pulsante [!UICONTROL Customize table] in alto a destra nella tabella. Le nuove colonne della tabella includono: <ul><li>**[!UICONTROL Scheduled]**: Imposta su [!UICONTROL On] quando un progetto è pianificato o [!UICONTROL Off] quando non lo è. Fai clic su [!UICONTROL On] link ti consente di visualizzare informazioni sul progetto pianificato. È inoltre possibile [modifica la pianificazione del progetto](/help/analyze/analysis-workspace/curate-share/t-schedule-report.md) se sei il proprietario del progetto.</li><li>**[!UICONTROL Project ID]**: L’ID del progetto può essere utilizzato per il debug dei progetti.</li><li>**[!UICONTROL Longest Date Range]**: Intervalli di date più lunghi aumentano la complessità del progetto e possono aumentare i tempi di elaborazione e caricamento. </li><li>**[!UICONTROL Number of Queries]**: Il numero totale di richieste effettuate ad Analytics al caricamento del progetto. Un numero più elevato di query di progetto aumenta la complessità del progetto e può aumentare i tempi di elaborazione e caricamento. Questi dati sono disponibili solo dopo il caricamento di un progetto o l’invio di un progetto pianificato. </li></ul> | ![Nuove colonne](assets/new-columns.png) |
| Fare clic per aprire un rapporto | In precedenza era necessario fare doppio clic. |  |
| Nuovi collegamenti a **[!UICONTROL Reports & Analytics]** rapporti | <ul><li>**[!UICONTROL Reports]** > **[!UICONTROL Audience]** > **[!UICONTROL Bots]**</li><li>**[!UICONTROL Reports]** > **[!UICONTROL Audience]** > **[!UICONTROL Bot Pages]**<li>**[!UICONTROL Reports]** > **[!UICONTROL Engagement]** > **[!UICONTROL Real-Time]**</li></ul> | ![Nuovi collegamenti](assets/report-links.png) |
| Nuovi report predefiniti | <ul><li>**[!UICONTROL Reports]** > **[!UICONTROL Most popular]** > **[!UICONTROL Next page]**</li><li>**[!UICONTROL Reports]** > **[!UICONTROL Most popular]** > **[!UICONTROL Previous page]**</li><li>**[!UICONTROL Reports]** > **[!UICONTROL Engagement]** > **[!UICONTROL Page analysis]** > **[!UICONTROL Page summary]**</li></ul>Tieni presente che questi rapporti sono [!UICONTROL Workspace] e richiedono la configurazione e la generazione. L’output è costituito da un pannello di metriche di alto livello, dati con tendenze, [!UICONTROL Flow] visualizzazione e altro ancora. Puoi modificare questi rapporti e modificare dimensioni, elementi dimensionali, ecc. Questi rapporti sono disponibili anche come pannelli nei pannelli di Workspace. | ![Pagina successiva](assets/next-page.png) |
| **[!UICONTROL Create new]** il modale è tornato | Quando fai clic su **[!UICONTROL Create new]** in Workspace, puoi nuovamente scegliere tra un [!UICONTROL Blank project] e [!UICONTROL Blank mobile scorecard]. Puoi anche scegliere tra tutti i modelli creati dalla tua azienda. | ![Crea nuovo](assets/create-new.png) |
| Disponibile anche in CJA | Questa pagina di destinazione, in un modulo modificato, sarà disponibile anche in CJA. |  |

{style=&quot;table-layout:auto&quot;}

## Accedere alla pagina di destinazione {#access-landing}

Dopo aver effettuato l’accesso ad Adobe Experience Cloud e Analytics, attiva il pulsante [!UICONTROL New landing page - Beta], in basso a sinistra. L’accesso al pulsante di attivazione/disattivazione è specifico per l’utente per organizzazione e non per azienda.
...
* **[!UICONTROL Reports]** fa riferimento a qualsiasi cosa pregenerata da Adobe, ad esempio i rapporto di Reports &amp; Analytics e i modelli di Workspace.
...
![Destinazione completa](assets/landing-all.png)
...
| [!UICONTROL Create project] | Il menu a discesa consente di creare un [!UICONTROL Workspace project] o un [!UICONTROL Mobile project]. |
| [!UICONTROL Show less/more] | Consente di passare dalla visualizzazione o meno del banner: ![Banner superiore](assets/top-banner.png) |
...
| [!UICONTROL Open Training Tutorial] |  Il tutorial su Workspace che mostra ai nuovi utenti come creare un progetto, illustrando i vari passaggi. |
...
* La maggior parte dei rapporti predefiniti che si trovavano nel precedente menu superiore [!UICONTROL Reports] di Adobe Analytics. Questi rapporti sono ora visualizzati in [Analysis Workspace](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=en).
...
![Scheda Rapporti](assets/reports-tab.png)
...
1. Aggiungi tutti i campi desiderati al modale e salvalo.
   ...
   Il rapporto viene aggiunto all’elenco dei rapporti aziendali ed è disponibile per coloro che fanno parte della società da cui accedi.
...
| Il lavoro che eseguo nell’interfaccia utente del programma beta viene trasferito alla produzione [!UICONTROL Workspace] esperienza? | Sì, qualsiasi lavoro svolto nella versione beta viene trasferito alla vecchia/corrente [!UICONTROL Workspace] esperienza. |
| Sono al corrente [!DNL Reports & Analytics] preferiti riportati? | No, NON sono riportati. Tuttavia, [!UICONTROL Workspace] i preferiti dei progetti vengono riportati. |
