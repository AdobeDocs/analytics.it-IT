...
| --- | --- | --- |
| Espandi [!UICONTROL Projects] da tabella a schermo intero | Per espandere l&#39;immobile della tabella, basta fare clic sull&#39;icona del menu hamburger. Questa azione comprime le schede della barra a sinistra. | ![Espandi tabella](assets/landing-collapse.png) |
...
| Nuovi collegamenti ai rapporti di Reports &amp; Analytics | <ul><li>Rapporti > Pubblico > Bot</li><li>Rapporti > Pubblico > Pagine bot<li>Rapporti > Coinvolgimento > In tempo reale</li></ul> | ![Nuovi collegamenti](assets/report-links.png) |
| Nuovi report predefiniti | <ul><li>Rapporti > Più popolari > Pagina successiva</li><li>Rapporti > Più popolare > Pagina precedente</li><li>Rapporti > Coinvolgimento > Analisi pagina > Riepilogo pagina</li></ul>Tieni presente che questi rapporti sono in formato Workspace e richiedono la configurazione e la compilazione. L’output è costituito da un pannello di metriche di alto livello, dati con tendenze, [!UICONTROL Flow] visualizzazione e altro ancora. Puoi anche modificare questi rapporti e modificare dimensioni, elementi dimensionali, ecc. Questi rapporti sono disponibili anche come pannelli nei pannelli di Workspace. | ![Pagina successiva](assets/next-page.png) |
| [!UICONTROL Create new] il modale è tornato | Quando fai clic su [!UICONTROL Create new] in Workspace, puoi nuovamente scegliere tra un progetto vuoto e una scorecard mobile vuota. Puoi anche scegliere tra tutti i modelli creati dalla tua azienda. | ![Crea nuovo](assets/create-new.png) |
...
| Mostra meno/altro | Consente di visualizzare o meno il banner: ![Banner superiore](assets/top-banner.png) |
