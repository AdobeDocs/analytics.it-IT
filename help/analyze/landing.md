---
description: Spiega come la pagina di destinazione riunisce sia Analysis Workspace che Reports & Analytics in un’unica interfaccia e in un unico punto di accesso sotto l’ombrello di Workspace.
...
La pagina di destinazione di Adobe Analytics riunisce Analysis Workspace e Reports &amp; Analytics in un’unica interfaccia e in un unico punto di accesso sotto l’ombrello di Workspace. Offre una home page di project manager, un menu aggiornato dei rapporti, rapporti aggiornati e una sezione di apprendimento per aiutarti a iniziare in modo più efficace.
...
Dopo aver effettuato l’accesso ad Adobe Experience Cloud e Analytics, attiva il pulsante [!UICONTROL New landing page - Beta], in basso a sinistra. L’accesso al pulsante di attivazione/disattivazione è specifico per l’utente per ogni organizzazione e non per una specifica azienda.

![Atterraggio](assets/landing.png)

## Struttura del menu

![Menu principale](assets/top-menus.png)

* Menu principale di Analytics: La maggior parte dei rapporti si trova ora nel menu [!UICONTROL Reports] nella barra a sinistra.
...
| Icona Fissa (a forma di puntina) | È possibile fissare gli elementi che *sempre* appaiono in cima all&#39;elenco. |
