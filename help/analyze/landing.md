...
| --- | --- |
| Tutorial di formazione | Più popolare > Esercitazione di formazione |
...
| Analisi multidispositivo | Coinvolgimento > Analisi multidispositivo |
| Conservazione Web | Coinvolgimento > Conservazione Web |
| Consumo audio di contenuti multimediali | Coinvolgimento > Consumo audio multimediale |
| Media Recency, Frequenza, Fedeltà | Coinvolgimento > Media Recency, Frequenza, Fedeltà |
...
| Utilizzo app mobili | Pubblico > Mobile > Utilizzo app mobile |
| Percorsi di app mobili | Pubblico > Mobile > Percorsi di app mobili |
| Metriche di app mobili | Pubblico > Mobile > Messaggistica dell&#39;app mobile |
| Prestazioni app mobili | Pubblico > Mobile > Prestazioni app mobili |
| Conservazione delle app mobili | Pubblico > Mobile > Conservazione app mobile |
| Prestazione campagna | Acquisizione > Campagne > Prestazioni campagna |
| Acquisizione mobile | Acquisizione > Acquisizione mobile |
| Acquisizione Web | Acquisizione > Web Acquisition |
...
I rapporti personalizzati si chiamano Rapporti aziendali e si trovano nel menu Rapporti aziendali (vedi sotto). Sono elencati tutti i nuovi e quelli creati in precedenza.

Per creare una nuova segnalazione aziendale,

1. Crea l’area di lavoro allo stato desiderato.
1. Apri il menu [!UICONTROL Project] e fai clic su **[!UICONTROL Save as company report…]**.

   ![Report dell&#39;azienda](assets/company-report.png)
