...
<table id="table_8AC3A26FF02143DBA949B30F2A46CF11"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Corrisponde <span class="term"> a b c</span>e <span class="term"> b bis</span>e così via. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>abc </p> </td> 
   <td colname="col3"> <p>Escludi <span class="term"> abc</span>, <span class="term"> abc def</span> e corrispondenti <span class="term"> def</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Non corrisponde <span class="term"> a</span>. </p> <p>Corrisponde <span class="term"> a b c</span>. </p> <p>Corrisponde <span class="term"> abc</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Inizia con </p> </td> 
   <td colname="col02"> <p>Restituisce risultati che iniziano con un valore specifico. </p> </td> 
   <td colname="col2"> <p>abc </p> </td> 
   <td colname="col3"> <p>Corrisponde <span class="term"> abcd</span> ma non <span class="term"> 1 abc</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Definisce un filtro che inizia con <span class="term"> Pagina principale</span>, cerca uno o più caratteri e termina con <span class="term"> Pagina</span>. </p> <p>Inoltre, qualsiasi pagina con <span class="term"> sport</span> in esso. </p> <p>Alcuni esempi corrispondono: </p> 
...
<table id="table_8BBB06C8860745DEA41B39673699DC0F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Non è evitato a meno che non sia abbinato ad un'altra citazione. Ad esempio: <span class="term"> Display da 17"</span> Non è una frase. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> * </td> 
