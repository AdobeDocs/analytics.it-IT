---
title: Panoramica del Report Builder
description: Scopri la funzionalità Report Builder.
role: User
...
Con Report Builder per Adobe Analytics puoi:
...
Report Builder for Adobe Analytics è un componente aggiuntivo di Microsoft Excel. Il componente aggiuntivo è disponibile nelle seguenti piattaforme:
...
### Utilizzo affiancato di entrambe le versioni
...
### Funzioni legacy di Report Builder non supportate

Alcune [funzionalità legacy di Report Builder non sono supportate](convert-workbooks.md#legacy-report-builder-features-not-supported) in questo Report Builder.
...
>[!IMPORTANT]
>
>Questo video introduttivo mostra l’interfaccia utente di Report Builder in Customer Journey Analytics. Alcuni termini e interfaccia utente differiscono quando si utilizza Report Builder in Adobe Analytics. In caso contrario, l’esperienza utente è identica.


>[!BEGINSHADEBOX]

Per un video demo, vedi ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Panoramica di Report Builder](https://video.tv.adobe.com/v/3452588?captions=ita&quality=12&learn=on){target="_blank"}.

>[!ENDSHADEBOX]

Puoi scaricare Report Builder da Adobe Analytics da [Microsoft Store](https://appsource.microsoft.com/en-us/product/office/WA200003101?tab=Overview).
