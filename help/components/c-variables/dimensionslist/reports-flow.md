---
description: Flusso mostra i percorsi più comuni seguiti dagli utenti tra pagine, sezioni del sito e server.
title: Flusso
topic: Reports
...
Per informazioni sul funzionamento di Flusso in **Analysis Workspace**, consulta Percorso [cliente - Flusso](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md).
