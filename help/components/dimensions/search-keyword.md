...
* Il dominio di riferimento è riconosciuto da Adobe come un [motore di ricerca](search-engine.md) valido;
...
Per distinguere la ricerca a pagamento da quella naturale, è necessario [Rilevamento ricerca a pagamento](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/general/paid-search-detection/paid-search-detection.md). Sono disponibili più dimensioni per le parole chiave di ricerca:
...
Gli elementi di Dimension includono le parole chiave di ricerca utilizzate per raggiungere il sito. L&#39;elemento dimensione `"Unspecified"` è tutto traffico non di ricerca.
