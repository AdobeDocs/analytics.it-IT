...
Adobe determina questa dimensione lato server, in base al fatto che l’identificatore del visitatore dell’hit provenga da un’origine che in genere persiste (come un cookie). Non c’è alcuna variabile da impostare e funziona per tutte le implementazioni.

| Proprietà | Valore |
| --- | --- |
| **Variabile AppMeasurement** | Nessuno (lato server derivato) |
| **Campo Web SDK / XDM** | Nessuno (lato server derivato) |
| **Parametro query** | N/D |
| **Tag XML** | N/D |
| **Limite di byte** | N/D |
| **Persistenza** | N/D |
