...
Adobe deriva questa dimensione lato server dall’indirizzo IP del visitatore, confrontandolo con una tabella di ricerca interna. Adobe collabora con [elemento digitale](https://www.digitalelement.com/) per mantenere le ricerche tra l&#39;indirizzo IP e lo stato degli Stati Uniti. Nessuna variabile da impostare.
