...
Adobe deriva questa dimensione lato server dall’indirizzo IP del visitatore, confrontandolo con una tabella di ricerca interna. Adobe collabora con [elemento digitale](https://www.digitalelement.com/) per mantenere le ricerche tra indirizzo IP e paese. Nessuna variabile da impostare.
