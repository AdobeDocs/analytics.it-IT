...
Questa dimensione è determinata da una combinazione di dati raccolti e logica lato server di Adobe, non da una variabile impostata.

| Proprietà | Valore |
| --- | --- |
| **Variabile AppMeasurement** | Nessuno |
| **Campo Web SDK / XDM** | Nessuno |
| **Parametro query** | [`ct`](https://developer.adobe.com/analytics-collection-apis/methods/data-insertion/variable-reference#variables) |
| **Tag XML** | [`<connectionType>`](https://developer.adobe.com/analytics-collection-apis/methods/data-insertion/variable-reference#variables) |
| **Limite di byte** | N/D |
| **Persistenza** | N/D |

Adobe utilizza le seguenti regole per determinarne il valore:
