...
AppMeasurement raccoglie automaticamente il referente dal valore `document.referrer` del browser. È possibile sovrascrivere il valore raccolto utilizzando la variabile [`referrer`](/help/implement/vars/page-vars/referrer.md). Devi anche configurare i [filtri per URL interni](/help/admin/tools/manage-rs/edit-settings/general/internal-url-filter-admin.md) della suite di rapporti; in caso contrario, potrai includere URL interni o impedire la visualizzazione di URL esterni.

| Proprietà | Valore |
| --- | --- |
| **Variabile AppMeasurement** | [`referrer`](/help/implement/vars/page-vars/referrer.md) |
| **Campo Web SDK / XDM** | [`web.webReferrer.URL`](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/data-types/web-information) |
| **Parametro query** | [`r`](https://developer.adobe.com/analytics-collection-apis/methods/data-insertion/variable-reference#variables) |
| **Tag XML** | [`<referrer>`](https://developer.adobe.com/analytics-collection-apis/methods/data-insertion/variable-reference#variables) |
