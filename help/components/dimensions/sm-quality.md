...
Le dimensioni di qualità dei servizi di contenuti multimediali in streaming forniscono rapporti relativi alla qualità dei contenuti utilizzati dal visitatore. Queste dimensioni richiedono **[!UICONTROL Adobe Analytics for Streaming Media Add-on]**. Per informazioni, contatta il team del tuo account di Adobe.

Per utilizzare queste dimensioni, abilita **[!UICONTROL Media Quality]** in [[!UICONTROL Media Reporting]](/help/admin/tools/manage-rs/edit-settings/media-management.md) per la suite di rapporti.
