...
Consulta [Informazioni sui segmenti](/help/components/segmentation/seg-overview.md) per una panoramica rapida. Quindi vai a [Configurazione di un flusso di lavoro di segmentazione](/help/components/segmentation/segmentation-workflow/seg-workflow.md) o [Generare segmenti](/help/components/segmentation/segmentation-workflow/seg-build.md).
