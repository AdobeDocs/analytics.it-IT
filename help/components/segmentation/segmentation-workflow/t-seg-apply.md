...
* Generatore di [definizioni per una metrica calcolata](/help/components/c-calcmetrics/c-workflow/cm-workflow/c-build-metrics/cm-build-metrics.md#definition-builder), in modo da includere un segmento nella definizione della metrica calcolata.
