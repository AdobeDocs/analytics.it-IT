...
La gestione avvisi è strutturata come la [gestione segmenti](/help/components/segmentation/segmentation-workflow/seg-manage.md) e la [gestione metriche calcolate](/help/components/calculated-metrics/workflow/cm-manager.md).
