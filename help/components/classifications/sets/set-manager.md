...
| Colonna | Descrizione |
|---|---|
| **[!UICONTROL Classification Set]** | Nome del set di classificazione. Selezionare il nome per [modificare il set di classificazione](create.md#edit-a-classification-set). |
