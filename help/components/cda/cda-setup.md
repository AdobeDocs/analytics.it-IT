...
description: Scoprite come configurare  Analytics su più dispositivi dopo aver soddisfatto i prerequisiti.
...
>[!IMPORTANT]
>
>Tutti i prerequisiti devono essere soddisfatti prima di seguire questi passaggi. Se tutti i prerequisiti non sono soddisfatti, la funzione non è disponibile o non funziona. Consultate [Presupposti e limitazioni per dispositivi  Analytics](cda-home.md) .
