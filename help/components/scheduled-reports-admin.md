...
Questa coda ti consente di gestire ed eventualmente eliminare qualsiasi rapporto pianificato che sta “intasando” la coda. (In genere, i rapporti vengono interrotti per timeout dopo 4 ore.)
