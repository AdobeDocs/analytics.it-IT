...
L&#39;API di inserimento dati e l&#39;[API di inserimento dati in blocco](https://developer.adobe.com/analytics-collection-apis/methods/bulk-data-insertion/) sono entrambi metodi per inviare i dati della raccolta lato server ad Adobe Analytics. Le chiamate API di inserimento dati vengono effettuate un evento alla volta. L’API di inserimento dati in blocco accetta file in formato CSV contenenti dati evento, un evento per riga. Se stai lavorando a una nuova implementazione della raccolta lato server, Adobe consiglia di utilizzare l’API di inserimento dati in blocco.

Per l&#39;autenticazione, gli endpoint, il formato del file, il riferimento alla colonna e la risoluzione dei problemi, consulta la documentazione sull&#39;[API di inserimento dati in blocco](https://developer.adobe.com/analytics-collection-apis/methods/bulk-data-insertion/) in Adobe Developer.
