...
* **[API di inserimento dati in blocco](/help/import/bulk-data-insertion-api/bulk-data-insert.md)** consente di caricare i dati delle chiamate server in batch di file invece di utilizzare librerie lato client come AppMeasurement.
