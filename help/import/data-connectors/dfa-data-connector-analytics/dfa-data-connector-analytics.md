...
* **Analisi** a valore aggiunto: L'integrazione automatizzata tra DFA e Adobe Reports &amp; Analytics consente a inserzionisti e agenzie di dedicare meno tempo all'analisi dei report e all'adozione di misure.
...
* **Report** integrato: Sincronizza automaticamente i dati tra DFA e Reporting e analisi per processi aziendali semplificati e reporting.
...
La tabella seguente riassume le funzioni di ciascuna versione dell'integrazione.
...
A partire dalla versione 2.0 dell’integrazione sono disponibili anche le metriche Media Cost. Per abilitare le metriche dei costi dei supporti per un'integrazione, devi scegliere un evento Reporting e analisi per i costi dei supporti nella procedura guidata Genesi, nonché specificare la valuta in cui si trovano le cifre delle metriche nell'interfaccia DFA.

I timeout dovrebbero diminuire con l'integrazione 2.0, poiché i reindirizzamenti 302 sono stati eliminati. L’eliminazione di questi hop dovrebbe ridurre i timeout e aumentare la quantità di dati DFA che puoi integrare.
...
|---|---|---|
| Da 1.0 a 1.5 | Client | Implementazione della versione 1.5 JavaScript con il modulo integrato |
