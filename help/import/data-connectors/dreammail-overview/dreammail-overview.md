---
description: Questa integrazione e-mail di Adobe® Data Connectors™ combina le informazioni comportamentali di Analytics® con il marketing e-mail per creare uno strumento efficace per ridefinire la misurazione del successo e indirizzare i tipi di pubblico a messaggi più pertinenti.
seo-description: Questa integrazione e-mail di Adobe® Data Connectors™ combina le informazioni comportamentali di Analytics® con il marketing e-mail per creare uno strumento efficace per ridefinire la misurazione del successo e indirizzare i tipi di pubblico a messaggi più pertinenti.
seo-title: Connettore dati DreamMail per Adobe Analytics
...
Questa integrazione e-mail di Adobe® Data Connectors™ combina le informazioni comportamentali di Analytics® con il marketing e-mail per creare uno strumento efficace per ridefinire la misurazione del successo e indirizzare i tipi di pubblico a messaggi più pertinenti.
...
Questo aumento dell'efficienza del marketing è uno dei vantaggi chiave dell'integrazione [!DNL Analytics] con [!DNL ~i partner~]. Inoltre, questa integrazione sincronizzerà automaticamente le metriche delle e-mail con [!DNL Analytics] i dati con la frequenza oraria per il reporting a circuito chiuso.
...
* **[!DNL ~~Partner]**: L'integrazione richiede l'acquisizione e la memorizzazione di un indirizzo e-mail all'interno di una variabile di Analytics (eVar). Il " [!DNL ~Partner~]" è associato al comportamento a valle dei visitatori sul sito (carrelli abbandonati, acquisti, ecc.) che viene incluso nel sistema [!DNL ~Partner~] e può essere sfruttato per scopi di remarketing. Durante il processo di configurazione, è necessario identificare un'eVar a tale scopo quando richiesto dalla procedura guidata.
...
Questa integrazione potrebbe comportare costi ricorrenti per l'implementazione. Contattate [!DNL DreamMail] per informazioni sui prezzi.

## Analytics Integration Variables{#analytics-integration-variables}

Questa integrazione richiede che le variabili di Analytics tengano traccia delle metriche.

Dopo aver identificato gli eventi e le eVar da utilizzare con questa integrazione, devono essere abilitate nell’Admin Console di Analytics (consultate le [suite](https://docs.adobe.com/content/help/en/analytics/admin/manage-report-suites/report-suites-admin.html) di rapporti per le istruzioni).
