---
description: Le metriche seguenti sono sincronizzate nell'integrazione appfigures.
seo-description: Le metriche seguenti sono sincronizzate nell'integrazione appfigures.
seo-title: Metriche e dimensioni
...
Le metriche seguenti sono sincronizzate nell'integrazione appfigures.

| Metrica | Descrizione |
|---|---|
| Download dall'app store | Numero di download delle applicazioni mobili. |
| Acquisti app store (nell'app) | Numero di acquisti in-app. |
| Classifica app store | Utilizzato per definire la metrica calcolata appfigures calcolata. Non utilizzato direttamente. |
| Divisor classifica app store | Utilizzato per definire la metrica calcolata appfigures calcolata. Non utilizzato direttamente. |
| Valutazione app store | Utilizzato per definire la metrica calcolata appfigures calcolata. Non utilizzato direttamente. |
| Divisor Valutazione app store | Utilizzato per definire la metrica calcolata appfigures calcolata. Non utilizzato direttamente. |
| Ricavi da app store (nell'app) | Quantità di ricavi da app. |
| Ricavi da app store (uno disattivato) | La quantità di ricavi associati all'acquisto di un'app. |
| Royalty App Store (nell'app) | Obsoleto. |
| Royalty App Store (una disattivato) | Obsoleto. |

Le seguenti dimensioni di classificazione riservate vengono create dalla procedura guidata di connettori dati per l'evar riservato dell'ID oggetto appfigures.

| Dimensione classificazione | Descrizione |
|---|---|
| Nome paese | Il nome del paese correlato all'attività dell'app store. |
| Nome del dispositivo | Il nome del dispositivo mobile correlato all'attività dell'app store. |
| Nome appstore | Il nome dell'appstore che ha segnalato l'attività. |
| Nome applicazione | Il nome dell'applicazione mobile. |
| Nome in-app | L'elemento acquistato all'interno dell'applicazione. |
| Nome categoria | Categoria principale dell'app nell'app store. |
| Titolo revisione | Titolo della revisione. |
| Rivedi commento | Commento della revisione |
| Versione applicazione | Versione dell'applicazione utilizzata per generare la revisione. |
| Utente App Store | Autore (nome utente) della recensione. |

La seguente metrica calcolata viene creata dalla procedura guidata Connettori dati:

<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Metrica calcolata </th> 
   <th colname="col2" class="entry"> Descrizione </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> Classificazione media dell'app store (numerico) </td> 
   <td colname="col2"> <p>La classificazione media dell'app. Questa metrica calcolata viene definita utilizzando la formula seguente: </p> <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; Classifica] &amp; amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Classifica &amp; amp; nbsp; Divisore] </code> <p>Nota: Il numero di applicazioni classificate per categoria e paese varia a seconda dell'app store. Se l'applicazione è classificata in base a questa soglia, le classificazioni delle applicazioni non sono disponibili. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Valutazione media in app store </td> 
   <td colname="col2"> Valutazione media dell'app. Questa metrica calcolata viene definita utilizzando la formula seguente: <code> [App &amp; amp; nbsp; Store &amp; amp; nbsp; Valutazione] &amp; amp; nbsp; /&amp; amp; nbsp; [App &amp; amp; nbsp; Store &amp; amp; nbsp; Valutazione &amp; amp; nbsp; Divisore] </code> </td> 
  </tr> 
 </tbody> 
</table>

## Dimensioni rilevanti per ogni metrica appfigures {#section-cd356d3dce04412893beed345305c247}

Nella tabella seguente sono illustrate le dimensioni del report correlate alle metriche.

<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   <td> </td> 
   <td> Download da app store </td> 
   <td> Acquisti app store (in-app) </td> 
   <td> Classifica app store </td> 
   <td> Divisor classifica app store </td> 
   <td> Valutazione app store </td> 
   <td> Divisor Valutazione app store </td> 
   <td> Ricavi da app store (in-app) </td> 
   <td colname="col9"> Ricavi da app store (una tantum) </td> 
   <td colname="col10"> App Store Avg. Classifica </td> 
   <td colname="col11"> App Store Avg. Valutazione </td> 
  </tr> 
  <tr> 
   <td> Nome paese </td> 
  ...
  <tr> 
   <td> Nome categoria classifica </td> 
