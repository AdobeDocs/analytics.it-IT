...
user-guide-description: Configurare le integrazioni con altre soluzioni Adobe CX Enterprise, come Audience Manager e Advertising.
...
+ [Guida all’integrazione di Analytics](home.md)
...
+ Audience Analytics {#audience-analytics}
  ...
  + Flusso di lavoro di Audience Analytics {#audience-analytics-workflow}
    ...
    + [Crea destinazione Analytics - Guida di Adobe Audience Manager](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/experience-cloud-destinations/create-analytics-destination.html?lang=it)
    + [Uso dei dati del pubblico in Analytics](c-audience-analytics/c-workflow/use-audience-data-analytics.md)
    + [Casi d’uso di Audience Analytics](c-audience-analytics/aam-audience-use-cases.md)
...
+ Advertising Analytics {#advertising-analytics}
  ...
  + Flusso di lavoro di configurazione di Advertising Analytics {#advertising-analytics-workflow}
    ...
    + [Abilitare suite di rapporti per Advertising Analytics](c-advertising-analytics/c-adanalytics-workflow/aa-provision-rs.md)
    ...
    + [Rapporto sui dati pubblicitari in Adobe Analytics](c-advertising-analytics/c-adanalytics-workflow/aa-report-ad-data-an.md)
...
+ [Adobe Analytics per Advertising](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/overview.html?lang=it)
+ [Adobe Analytics for Target - A4T](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/a4t.html?lang=it)
+ [Reportistica di Adobe Campaign in Adobe Analytics](adobe-campaign.md)
