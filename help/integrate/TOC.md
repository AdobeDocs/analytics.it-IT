...
+ Audience Analytics {#audience-analytics}
   ...
   + Flusso di lavoro di Audience Analytics {#audience-analytics-workflow}
      ...
      + [Creare destinazione Analytics - Guida di Adobe Audience Manager](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/experience-cloud-destinations/create-analytics-destination.html?lang=it)
...
+ [Adobe Analytics per Advertising Cloud](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/overview.html?lang=it)
