...
1. Locate **[!UICONTROL DoubleClick DFA]**, then click **[!UICONTROL Add New]**.
   ...
   On each page of the Integration Wizard, provide the required information, then click **[!UICONTROL Next]**. Nella tabella seguente sono illustrate le informazioni necessarie per completare l'integrazione tramite la procedura guidata.
...
<table id="table_8F6F7F304C36431DA5FD6E5D54F60FC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> Evar di Analytics che riceve l'attributo della campagna DFA, impression e fa clic sui dati. Typically, this is the Tracking Code eVar ( <span class="varname"> s.campaign </span>), but you can choose any available eVar. I Connettori dati aggiungono inoltre le seguenti classificazioni DFA alla evar selezionata: <p><b>Campagne</b>: Una raccolta di annunci serviti a più siti che hanno messaggi comuni. </p> <p><b>Nome sito</b>: Il sito in cui è stato distribuito l'annuncio. </p> <p><b>Nome annuncio</b>: Il nome Annuncio, come definito nell'account DFA. </p> <p><b>Nome posizionamento sito</b>: Sito Web e pagina in cui è stato distribuito l'annuncio. </p> <p><b>Strumento di consegna</b>: Doubleclick per Advertiser. </p> <p><b>Canale</b>: Banner Ad. </p> <p><b>Struttura costi</b>: CPM, CPC o Fisso, in base alla struttura costi dell'annuncio. </p> <p><b>Creativi</b>: Il nome delle credenziali associate a un annuncio/posizionamento/ID creativo. </p> <p><b>DFA &gt; Deduplicazione searchcenter</b>: Specifica che il DFA deve posizionare i valori nelle variabili Searchcenter quando si verificano click-through DFA o Visualizza-through. For more information, see <a href="../../dfa-data-connector-analytics/dfa-integration-features.md#concept-ff93289d1662410e98f62c200394b3e3" format="dita" scope="local"> SearchCenter Deduplication </a> . </p> </td> 
  </tr> 
  <tr> 
