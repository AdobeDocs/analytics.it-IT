...
title: Panoramica Audience Analytics
...
## Come funziona Audienci Analytics {#works}
...
1. Attraverso l’integrazione di Audienci Analytics, per ogni hit, l’iscrizione del pubblico di un visitatore viene cercata in Adobe Audience Manager e un elenco di ID segmento viene restituito ad Analytics per l’elaborazione in tempo reale.
...
Questi prerequisiti sono descritti nel [Flusso di lavoro Audienci Analytics](/help/integrate/c-audience-analytics/c-workflow/audiences-workflow.md).
