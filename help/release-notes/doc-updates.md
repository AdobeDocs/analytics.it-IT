...
* Per informazioni su [!UICONTROL Customer Journey Analytics], vedere [Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html?lang=it).
* Per informazioni sui servizi multimediali in streaming di Adobe, consulta [Misurazione di audio e video in Analytics](https://experienceleague.adobe.com/it/docs/media-analytics/using/media-overview).
...
| --- | --- |
| **Giugno 2026** | |
| Aggiornamento riferimento stringa query | Revisioni significative ai [parametri di query della raccolta dati](/help/implement/validate/query-parameters.md). |
...
| **Ottobre 2025** | |
| Set di classificazione | Aggiornamenti alla documentazione dei [set di classificazione](/help/components/classifications/sets/overview.md). |
...
| Ulteriori miglioramenti nell’identificazione dei visitatori | È stata aggiunta la sezione [Identificazione visitatore](/help/implement/id/overview.md), che illustra il modo consigliato per identificare i visitatori in tutti i tipi di implementazione. |
| **Settembre 2025** | |
| Miglioramenti nell’identificazione dei visitatori | Sono state rese più chiare le best practice sull&#39;identificazione dei visitatori, concentrandosi sullo scopo delle variabili `trackingServer` e [`trackingServerSecure`](/help/implement/vars/config-vars/trackingserversecure.md) in AppMeasurement. |
| **Agosto 2025** | |
...
| **Luglio 2025** | |
| Regole di elaborazione | La documentazione relativa alle regole di elaborazione è stata completamente rivisitata, fornendo ulteriori dettagli sull’interfaccia e sui casi di utilizzo correnti. |
...
| Revisione e aggiornamenti | Revisione e aggiornamento della documentazione di Analysis Workspace. Laddove appropriato, la documentazione di è ora sincronizzata con la documentazione di Customer Journey Analytics su Analysis Workspace. |
| **Giugno 2025** | |
...
| `cookieDomainPeriods` obsoleta | Ora che AppMeasurement rileva automaticamente il dominio corretto su cui impostare i cookie, la variabile [`cookieDomainPeriods`](/help/implement/vars/config-vars/configuration-variables.md#retired-configuration-variables) è obsoleta. |
...
| **Aprile 2024** | |
| È stata rimossa la documentazione relativa al “Proprietario” nei set di classificazione | Il filtro e la colonna “Proprietario” sono stati rimossi dalla [Gestione set di classificazione](/help/components/classifications/sets/manage-sets.md) e il campo “Proprietario” è stato rimosso dalle [Impostazioni del set di classificazione](/help/components/classifications/sets/manage/settings.md). <p>La documentazione è stata aggiornata per rimuovere filtro, colonna e campo.</p> |
...
| **Marzo 2024** | |
| Aggiornamento AppMeasurement | [Note sulla versione](/help/implement/appmeasurement-updates.md) sull’aggiornamento AppMeasurement v2.26.0.<br/>Include riferimento e aggiornamento della documentazione sulle variabili di configurazione [`cookieDomainPeriods`](/help/implement/vars/config-vars/configuration-variables.md#retired-configuration-variables). |
...
| 5 agosto 2021 | Nuovo argomento sul conteggio delle istanze ripetute. |
...
| 3 giugno 2021 | È stata aggiornata la documentazione per spiegare meglio [Implementazione feed dati](/help/export/analytics-data-feed/create-feed.md) e [BucketOwnerFullControl](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl). |
...
| Funzione | Descrizione |
| --- | --- |
| 19 dicembre 2020 | Il [limite predefinito per l’archiviazione dei dati FTP](/help/export/ftp-and-sftp/ftp-limits.md) è stato aggiornato a 10 GB. |
...
| 21 novembre 2019 | Sono state aggiornate le [domande frequenti sul flusso di lavoro di Audience Analytics](/help/integrate/c-audience-analytics/mc-audiences-faqs.md) per indicare la disponibilità in LiveStream. |
| 25 ottobre 2019 | È stata aggiornata la pagina sui [concetti chiave di Adobe Analytics](/help/technotes/terms.md). |
| 10 ottobre 2019 | Sono stati aggiornati i totali delle tabelle a forma libera: ora includono due totali, **[!UICONTROL Table total]** e **[!UICONTROL Grand total]**. Il conteggio delle righe totali della tabella tiene ora conto i [filtri dei report](/help/analyze/analysis-workspace/visualizations/freeform-table/filter-and-sort.md) applicati. Precedentemente, solo la segmentazione interessava i totali. [Ulteriori informazioni](/help/analyze/analysis-workspace/visualizations/freeform-table/workspace-totals.md)<br/>Inoltre, sono state aggiunte le opzioni **[!UICONTROL Show Totals]** e **[!UICONTROL Show Grand Total]** a **[!UICONTROL Column Settings]**.<br/>Con questa modifica ai totali delle tabelle a forma libera verranno aggiornate le visualizzazioni dipendenti (ad esempio le visualizzazioni **[!UICONTROL Summary Number]** collegate), nonché i dati CSV e PDF esportati. |
...
| 19 settembre 2019 | È stata rivista la documentazione sulla segmentazione per spiegare [i contenitori Gruppo logica](/help/components/segmentation/segmentation-workflow/seg-sequential-build.md#logic-group-containers). |
| 12 settembre 2019 | Nuova documentazione per [Analisi multidispositivo](/help/components/cda/overview.md) |
...
| 17 gennaio 2019 | [Analisi per coorte](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) - Importanti miglioramenti apportati all’analisi per coorte consentono di:<ul><li>Applica separatamente le metriche di inclusione e di ritorno di un segmento. </li><li>Mostra abbandono invece di fidelizzazione.</li><li>Mostra le tabelle di latenza (tempo trascorso prima e dopo un evento di inclusione).</li><li>Personalizza la dimensione della coorte (per raggruppare i visitatori in base a un eVar, non solo al tempo).</li><li>Eseguire un calcolo continuo per coorti: calcolare fidelizzazione e abbandono in base al periodo di tempo precedente, non alla coorte originale. </li><li>Puoi aggiungere più metriche nei campi di inclusione e di ritorno, nonché applicare segmenti. Le metriche calcolate non sono supportate</li></ul> |
