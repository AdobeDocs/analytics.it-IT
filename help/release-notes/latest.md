...
| --- | --- | --- |
| **Fine del ciclo di vita del servizio giapponese di tracciamento dei feature phone** | 21 marzo 2023 | Solo per i nostri clienti giapponesi: Alla **fine maggio 2023**, il servizio di tracciamento dei Feature Phone giapponese (mod_ktrack) verrà interrotto. Ci scusiamo per l’inconveniente, ma ti chiediamo di disinstallare o disabilitare i moduli installati sul tuo server Apache. Consulta le pagine 27 e 28 in [questo documento](/help/release-notes/mod_ktrackforSiteCatalyst_ver1.40.pdf) per riferimento. |
