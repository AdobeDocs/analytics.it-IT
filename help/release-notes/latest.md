...
# Note sulla versione corrente di Adobe Analytics (versione di settembre 2025)

**Ultimo aggiornamento**: venerdì 11 settembre 2025

Queste note sulla versione coprono il periodo di rilascio da settembre a inizio ottobre 2025. Le versioni di Adobe Analytics funzionano su un [modello di distribuzione continua](releases.md) che consente un approccio più scalabile e graduale all’implementazione delle funzioni. Di conseguenza, queste note sulla versione vengono aggiornate diverse volte al mese. Consultale regolarmente.
