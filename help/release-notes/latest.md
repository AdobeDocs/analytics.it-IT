...
| ----------- | ---------- | ---- |
| **Suddivisione del pannello**<br/> La zona di rilascio di un pannello offre ora la funzionalità aggiuntiva per [suddividere](/help/analyze/analysis-workspace/c-panels/panels.md#break-down-a-panel) (anziché segmentare) un pannello basato su una dimensione. | mercoledì 31 marzo 2026 | mercoledì 31 marzo 2026 |
