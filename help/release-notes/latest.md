...
| **Fine del ciclo di vita per Data Workbench** | 14 settembre 2022 | Adobe intende terminare il ciclo di vita di Data Workbench a partire dal **31 dicembre 2023**. Contatta il rappresentante dell’Assistenza clienti per trovare soluzioni alternative a Data Workbench o in caso di domande. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/data-workbench/using/eol.html?lang=it) |
