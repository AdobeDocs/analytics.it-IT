...
| **Sommario dei progetti Workspace** | È ora disponibile un nuovo sommario dei progetti. Il sommario fornisce collegamenti che consentono agli utenti di passare rapidamente a pannelli e visualizzazioni all’interno del progetto. Il sommario può essere abilitato per singoli progetti o per tutti i progetti di un determinato utente.<p>Per ulteriori informazioni, consulta [Sommario del progetto](/help/analyze/analysis-workspace/build-workspace-project/project-table-of-contents.md).</p> |  | 19 giugno 2024 |
