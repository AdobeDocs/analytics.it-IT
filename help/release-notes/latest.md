...
| ----------- | ---------- | ---------- |
| **Nuovo dominio per le e-mail generate dal sistema** | 13 luglio 2022 | Di recente, Adobe ha modificato il dominio del mittente per le e-mail da progetti Workspace, avvisi e avvisi di overage, da `noreply@omniture.com` a `noreply@adobe.com`. Aggiungi questo nuovo messaggio e-mail al tuo elenco consentiti se la tua organizzazione consente solo mittenti specifici. |
