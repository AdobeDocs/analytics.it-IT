...
| ----------- | ---------- | ---- |
| **Miglioramenti Activity Map**<br/> Activity Map include i seguenti miglioramenti:</p><ul><li>Supporto per le implementazioni di Activity Map Overlay con Web SDK di Adobe Analytics.</li><li>Supporto per il tracciamento Web SDK (quando il tracciamento viene eseguito su Analytics).</li><li>È stato aggiornato lo stile in tutta l’interfaccia utente.</li></ul><p>Il collegamento alla documentazione seguirà a breve.</p> | | Aprile 2026 |
