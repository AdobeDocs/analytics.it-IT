...
| **Nascondere gli intervalli di date di confronto nelle scorecard per dispositivi mobili** | Con le scorecard per dispositivi mobili, puoi attivare/disattivare **[!UICONTROL Include comparison dates]** impostazione per visualizzare o nascondere le date del confronto. | N/D | 8 febbraio 2023 |
