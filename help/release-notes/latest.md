...
| L’**utilizzo di Report Builder è incluso nella colonna “Utilizzato in” nel Gestore delle metriche calcolate e nel Gestore segmenti** | Visualizzando la colonna **Utilizzato in** in Gestione metriche calcolate o Gestione segmenti, i dati di utilizzo sono ora disponibili per Report Builder.<p>In precedenza, i dati di utilizzo in Gestore segmenti erano disponibili solo per Avvisi, Progetti, Progetti programmati e Metriche calcolate, mentre i dati di utilizzo in Gestore metriche calcolate erano disponibili solo per Avvisi, Progetti e Progetti programmati.</p> |  | A fine marzo o all’inizio di aprile |
