...
Utilizzate questo glossario per comprendere il contesto di molti termini utilizzati da Adobe Analytics.
...
* **Slot ASI:** Non esiste più. Nelle versioni precedenti di Adobe Analytics, gli slot ASI fornivano un contenitore di suite di rapporti temporaneo per visualizzare i dati segmentati. Nella versione corrente di Adobe Analytics, i segmenti possono essere applicati istantaneamente a qualsiasi report.
...
* **Variabile di conversione:** Noto anche come eVar. Memorizza un valore personalizzato e mantiene il valore della variabile fino alla scadenza. Consulta la dimensione [eVar](/help/components/dimensions/evar.md) nella guida utente Components (Componenti).
...
* **Attributi del cliente:** Funzione Experience Cloud che consente di caricare i dati attributo. Consulta Attributi [del](https://docs.adobe.com/content/help/it-IT/core-services/interface/customer-attributes/attributes.html) cliente nella guida utente ai servizi di base.
...
* **Dimensione:** Un tipo di componente che contiene valori variabili, come il testo. Alcuni esempi includono Nome pagina, Codice tracciamento o Dominio di riferimento. Una metrica è in genere la sua controparte.
* **Gestione tag dinamica:** La precedente soluzione di gestione tag di Adobe. Consulta Panoramica sull’implementazione di [Gestione dinamica dei tag](/help/implement/other/dtm/dtm-implementation-overview.md) nella guida per l’utente Implementa. Adobe consiglia di utilizzare Adobe Experience Platform Launch.
...
* **Hit:** Una singola richiesta di immagine inviata ai server di raccolta dati Adobe. Le visualizzazioni di pagina e i collegamenti personalizzati possono essere denominati entrambi hit.
* **Richiesta immagine:** Un&#39;immagine trasparente da 1x1 pixel utilizzata per comunicare con i server di raccolta dati Adobe. Un sito Web richiede questa immagine invisibile con una lunga stringa di query contenente dati; Adobe restituisce l’immagine invisibile e analizza la stringa di query ricevuta.
* **Insight:** Può fare riferimento a:
   * Nome precedente di Workbench dati.
...
* **Avvia:** Breve per Adobe Experience Platform Launch, l&#39;attuale soluzione di implementazione di Adobe. Consulta [Panoramica](https://docs.adobe.com/content/help/it-IT/launch/using/overview.html) nella guida utente di Adobe Experience Platform Launch.
...
* **Occorrenze:** Tipo di metrica che mostra il numero di hit impostati o persistenti per un valore di dimensione. Vedi la metrica [Occorrenze](/help/components/metrics/occurrences.md) nella guida utente Componenti.
...
* **Regole di elaborazione:** Può fare riferimento a:
   * Regole di elaborazione, un modo per modificare la raccolta dei dati utilizzando determinate regole in Admin Console. Consulta Regole [di](/help/admin/admin/c-processing-rules/processing-rules.md) elaborazione nella guida utente di amministrazione.
...
* **Segmento:** Consente di concentrarsi su un sottoinsieme specifico di dati. Consulta [Segmentazione](/help/components/c-segmentation/seg-overview.md) nella guida utente Components (Componenti).
* **Contenitore di segmenti:** La parte di un segmento che determina la quantità di dati da includere. I contenitori possono essere basati sulla visualizzazione della pagina, sulla visita o sul visitatore. Consulta [Segmentazione](/help/components/c-segmentation/seg-overview.md) nella guida utente Components (Componenti).
...
* **Variabile Traffico:** Noto anche come prop. Memorizza un valore personalizzato per un singolo hit. Le versioni precedenti di Adobe Analytics davano valore univoco ai prop, ma i miglioramenti alla piattaforma rendono le variabili di traffico personalizzate in gran parte inutili. Nella maggior parte dei casi, Adobe consiglia di utilizzare variabili di conversione personalizzate (eVar). Consulta la dimensione [Prop](/help/components/dimensions/prop.md) nella guida utente Components (Componenti).
