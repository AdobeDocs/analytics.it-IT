...
1. **Acquisisci familiarità con le etichette Privacy dei dati, gli ID di Adobe Analytics e i namespace.** Consulta [Etichette di Privacy dei dati per le variabili di Analytics](/help/admin/tools/privacy-labeling/labels.md) e [Tecniche di etichettatura consigliate](/help/admin/tools/privacy-labeling/best-practices.md).
