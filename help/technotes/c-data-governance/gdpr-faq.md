...
Per altre informazioni sulle etichette per la governance dei dati, vedi [ Etichette Privacy dei dati per le variabili di Analytics](/help/technotes/c-data-governance/data-labeling/gdpr-labels.md).
...
Per informazioni dettagliate su come prepararsi alle normative sulla Privacy dei dati, consulta [ Flusso di lavoro sulla privacy dei dati di Adobe Analytics](/help/technotes/c-data-governance/an-gdpr-workflow.md).
