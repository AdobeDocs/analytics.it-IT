...
>[!IMPORTANT]
>
>I rapporti di classificazione dei canali di marketing si comportano in modo leggermente diverso rispetto alle classificazioni standard: quando crei classificazioni per rapporti di primo o ultimo contatto, queste vengono applicate automaticamente a entrambi. Non è possibile classificare uno senza classificare l’altro.
...
| Nome | Nome della classificazione. La classificazione aggiunta viene visualizzata come opzione Suddivisione canali in Marketing Channel Manager . |
| Opzioni | Nome della classificazione. La classificazione aggiunta viene visualizzata come opzione Suddivisione canali in Marketing Channel Manager . |
