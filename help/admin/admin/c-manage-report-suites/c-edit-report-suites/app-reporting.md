...
title: Generazione rapporti sulle app
feature: Admin Tools
...
[!UICONTROL App Reports] Le dimensioni e le metriche vengono utilizzate per le seguenti finalità:
...
Quando si abilita [!UICONTROL App Reports], sono disponibili le seguenti dimensioni:

* [!UICONTROL Action Name] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
* [!UICONTROL App Id]
...
[!UICONTROL Location Tracking] Le dimensioni vengono utilizzate per i seguenti scopi:
...
Quando si abilita [!UICONTROL Location Tracking], sono disponibili le seguenti dimensioni:

* [!UICONTROL Beacon Major] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
* [!UICONTROL Beacon Minor] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
* [!UICONTROL Beacon Proximity] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
* [!UICONTROL Beacon UUID] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
...
[!UICONTROL Voice and Chatbots] Le dimensioni e le metriche consentono di misurare gli assistenti vocali come Alexa o Google Home. Consente inoltre di misurare i bot di chat cresciuti in casa. Le proprietà di misurazione includono:
...
Quando si abilita [!UICONTROL Voice and Chatbots], sono disponibili le seguenti dimensioni:

* [!UICONTROL Voice Device Capabilities] (con [Voce](/help/components/dimensions/entry-dimensions.md) e [Esci](/help/components/dimensions/exit-dimensions.md) dimensioni)
...
L’Adobe consiglia di disabilitare la generazione rapporti legacy in modo che gli hit in background non siano visibili. Se desideri includere hit in background nell’analisi, puoi abilitare [Suite di rapporti virtuale](/help/components/vrs/vrs-about.md) impostazione **[!UICONTROL Include background hits]**.
