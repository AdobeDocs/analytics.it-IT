...
Leggi le informazioni sugli [aumenti del tead time necessario per gli aumenti di traffico](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/c-traffic-management/traffic-lead-time.md) prima di pianificare un picco di traffico.
