...
* Periodo massimo di conservazione dei dati di 25 mesi.  Puoi rivedere le impostazioni attuali di conservazione dei dati in [!UICONTROL Analytics] > [!UICONTROL Admin] > [!UICONTROL Data Governance].  [Conservazione dati](https://experienceleague.adobe.com/docs/analytics/technotes/data-retention.html?lang=it)
