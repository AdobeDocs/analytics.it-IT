...
1. **Acquisisci familiarità con le etichette Privacy dei dati, gli ID di Adobe Analytics e i namespace.** Consulta [Etichette di Privacy dei dati per le variabili di Analytics](/help/admin/admin/c-data-governance/data-labeling/gdpr-labels.md) e [Tecniche di etichettatura consigliate](/help/admin/admin/c-data-governance/data-labeling/gdpr-analytics-ids.md).
