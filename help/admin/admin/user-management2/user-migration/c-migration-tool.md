 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sì. Tuttavia, Adobe consiglia di eseguire queste azioni prima dell’inizio della migrazione: </p> 
    ...
    </ul> <p>Per accelerare la migrazione, contatta il team dell’account Adobe all’indirizzo <a href="https://helpx.adobe.com/it/marketing-cloud/contact-support.html"> Adobe Customer Care</a> e invia una richiesta per una data di inizio precedente. </p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Queste funzioni rimarranno disponibili nella sezione Gestione utente di Analytics. </p> <p>Vedi <a href="/help/admin/admin/user-management2/user-migration/c-migration-tool.md"> Funzioni di Analytics non supportate in Adobe Admin Console</a> per ulteriori informazioni. </p> </td> 
  </tr> 
  <tr> 
