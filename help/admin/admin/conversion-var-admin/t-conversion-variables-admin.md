...
1. Sulla [!UICONTROL Conversion Variables] fai clic su **[!UICONTROL Expand]** icona [+] accanto alla variabile di conversione da modificare.
...
1. Seleziona i campi della variabile di conversione da modificare.
   ...
   Vedi [Variabili di conversione - Descrizioni](/help/admin/admin/conversion-var-admin/conversion-var-admin.md#section_7C317BB0287A4B8EB0A1A4ECC40627BF). Alcuni campi consentono di digitare direttamente nel campo . Altri consentono di selezionare da un elenco a discesa di valori supportati.
