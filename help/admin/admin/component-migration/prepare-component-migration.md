...
* Per acquisire i dati in Adobe Experience Platform per visualizzare i dati della suite di rapporti di Adobe Analytics nel Customer Journey Analytics, utilizza uno dei seguenti metodi:
   ...
   * Per utilizzare Web SDK, è necessario:
      ...
      * [Inserire dati tramite Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-data-ingestion/ingest-use-guides/edge-network/aepwebsdk.html)

* Creare un [connessione](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/overview.html?lang=it) e [visualizzazione dati](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=it) con i dati acquisiti.
...
* Decidi come mappare i componenti come organizzazione.
...
| **[Rilevamento delle anomalie](/help/analyze/analysis-workspace/virtual-analyst/c-anomaly-detection/anomaly-detection.md)** | ![segno di spunta](assets/Smock_Checkmark_18_N.svg) |
