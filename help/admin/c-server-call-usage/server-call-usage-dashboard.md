...
* Confronta l’utilizzo del periodo corrente con quello dell’anno scorso (linea blu). Ovviamente, la linea blu verrà visualizzata solo se l’azienda dispone di dati di utilizzo delle chiamate al server dell’anno precedente.
   ...
   >[!NOTE]
   >
   >Se desideri visualizzare l&#39;utilizzo per un periodo di tempo precedente, devi passare alla [Utilizzo della suite di rapporti](/help/admin/c-server-call-usage/report-suite-usage.md) e scarica i dati di utilizzo per un periodo precedente.
