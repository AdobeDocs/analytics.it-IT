...
seo-title: Panoramica sull'utilizzo delle chiamate server
  ...
  <tr> 
   ...
   <td colname="col3"> 
    <ol id="ol_13A984328D264488B7045DC7521A5F55"> 
     ...
     <li id="li_066D90AB071941C3869EDAFCE981707A">Andate in <span class="ignoretag"> Admin <span class="uicontrol"> &gt; </span> User Management <span class="uicontrol"> &gt; </span> Groups (Gestione utenti) &gt; <span class="uicontrol"> Edit All Report Access (Modifica accesso a tutti i rapporti) </span> &gt; Analytics Tools (Strumenti di Analytics) &gt;  <span class="uicontrol"> </span> <span class="uicontrol"> </span> <span class="uicontrol"> </span> <span class="uicontrol"> </span> Customize (Personalizza) &gt; (Utilizzo delle chiamate server) </span> </li> 
    </ol> </td> 
   <td colname="col4"> 
    <ol id="ol_518673ED323A4C5993A3B9F4BA09E405"> 
     ...
     <li id="li_22A4CBB84B5A451780873BBE67E6E6EF">Andate a <span class="ignoretag"> Products <span class="uicontrol"> &gt; </span> Product Profile <span class="uicontrol"> &gt; </span> Permissions (Prodotti) &gt; <span class="uicontrol"> Analytics Tools (Strumenti di </span> analisi) <span class="uicontrol"> &gt; </span> <span class="uicontrol"> </span> Server Call Usage (Utilizzo delle chiamate server) </span> </li> 
    </ol> </td> 
  </tr> 
 </tbody> 
</table>
