...
1. In [!UICONTROL Report Suite Groups] seleziona una suite di rapporti.
1. Digita un nome per il gruppo suite di rapporti.
1. Trascina le suite di rapporti da [!UICONTROL Report Suite List] al [!UICONTROL Drag Report Suites Here] area.
