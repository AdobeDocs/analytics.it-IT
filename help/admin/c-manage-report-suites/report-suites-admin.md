...
>[!NOTE]
>
>Le suite di rapporti virtuali vengono gestite tramite **[!UICONTROL Analytics]** > **[!UICONTROL Components]** > **[!UICONTROL Virtual Report Suites]**. Fare riferimento alla [documentazione relativa alla suite di rapporti virtuali](/help/components/vrs/vrs-about.md).

## Descrizioni di Report Suite Manager {#section_0C94DC9EACDA4F5891F5CD63EE80B125}

La tabella seguente descrive gli elementi della pagina [!UICONTROL Report Suite Manager].
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Gruppo dinamico che utilizza la funzione <span class="wintitle"> Ricerca avanzata</span> per definire un set di criteri che ne determinano i membri. Quando aggiungi o modifichi suite di rapporti in <span class="wintitle"> Report Suite Manager</span>, la funzione <span class="wintitle"> Saved Search</span> aggiunge automaticamente le suite di rapporti che soddisfano i relativi criteri. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> Rollup</span> </td> 
   <td colname="col2"> <p>Un rollup è una singola suite di rapporti che combina i dati di tracciamento di diverse altre suite di rapporti. </p> <p>Consulta <a href="/help/admin/c-manage-report-suites/rollup-report-suite.md"> Rollup Report Suites</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">Consulta <a href="/help/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> Nuova suite di rapporti</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Identifica le suite di rapporti in Strumenti di amministrazione e nell’elenco a discesa suite di rapporti nell’intestazione del rapporto di marketing. </p> <p>Consulta <a href="/help/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> Nuova suite di rapporti</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> URL di base</span> </td> 
   <td colname="col2"> <p>Definisce il dominio di base per la suite di rapporti. </p> <p>Consulta <a href="/help/admin/c-manage-report-suites/c-new-report-suite/new-report-suite.md"> Nuova suite di rapporti</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
