...
|------|------|
| Data Warehouse | Non utilizzato. Utilizza invece &quot;Rapporto Data Warehouse personalizzato&quot;. |
| Site Catalyst | Non utilizzato. Utilizza invece &quot;Analysis Workspace Access&quot;. |
...
| Installazione ClickMap legacy | Non utilizzato. In alternativa, utilizza Activity Map in Strumenti di Analytics. |
...
| Report di riepilogo della società | Non utilizzato. |
| Immagine | Non utilizzato. |
| Report KPI/Gage | Non utilizzato. |
| Totali nelle suite di rapporti | Non utilizzato. |
| Rapporto testo | Non utilizzato. |
| Rapporto di riepilogo dell&#39;utilizzo | Non utilizzato. |
