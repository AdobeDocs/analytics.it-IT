...
| [!UICONTROL Admin Tools UI Access] | Non utilizzato |
...
| [!UICONTROL Company Settings UI Access] | Non utilizzato |
...
| [!UICONTROL Data Governance & Privacy Labeling UI Access] | Consente di accedere ad Admin > Data Governance Privacy labels (Amministrazione > Etichette Privacy per la governance dei dati). |
...
| [!UICONTROL Legacy Report Builder] | Consente all&#39;utente di eseguire l&#39;autenticazione con il componente aggiuntivo Legacy Report Builder in Microsoft Excel. |
...
| [!UICONTROL MCP Access] | Consente l&#39;accesso all&#39;utilizzo del server [Adobe Analytics MCP](https://developer.adobe.com/analytics-mcp/docs/aa/). Per utilizzare questo strumento, questo elemento di autorizzazione è necessario per tutti gli utenti, inclusi gli amministratori di prodotto. |
...
| [!UICONTROL Report Suites Admin UI Access] | Consente di accedere ad Admin > Report suites (Amministrazione > Suite di rapporti), ma non di modificare le impostazioni o creare suite di rapporti. Utilizza gli elementi di autorizzazione [Strumenti della suite di rapporti](report-suite-tools.md) per consentire agli utenti di modificare selettivamente le impostazioni della suite di rapporti. |
| [!UICONTROL Reporting Activity Manager UI Access] | Consente di accedere ad Admin > Reporting Activity Manager (Amministrazione > Gestione attività di reporting). |
