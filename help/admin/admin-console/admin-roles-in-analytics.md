...
* **Amministratore prodotto:** Un amministratore di prodotto gestisce un prodotto in Admin Console, nonché le autorizzazioni utente per tale prodotto.
...
1. Fai clic su uno degli elementi della riga delle autorizzazioni. Se **[!UICONTROL Auto-include]** è disponibile, attivalo. Se **[!UICONTROL Auto-include]** non è disponibile, fare clic su **[!UICONTROL Add all]**. Entrambe le opzioni spostano tutti gli elementi delle autorizzazioni nella colonna a destra.
