...
1. Specifica il tipo di ID con cui vuoi eseguire la migrazione degli utenti ([Adobe ID o Enterprise ID](https://helpx.adobe.com/it/enterprise/help/identity.html)).
