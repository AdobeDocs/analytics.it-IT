...
* [Cos’è la migrazione degli ID utente di ](../c-migration-tool/c-migration-tool.md#section-adbe49aba10c4e62afa836a97894107c)
* [Cosa bisogna sapere prima di eseguire la migrazione degli ID utente (FAQ)](../c-migration-tool/c-migration-tool.md#section-b0fc7f0bbd4b488e95b0c8e77ff077a9)
* [Cosa bisogna sapere durante la migrazione (FAQ)](../c-migration-tool/c-migration-tool.md#section-d394524aa6d046d79025bbd7499792bc)
* [Cosa bisogna sapere dopo la migrazione (FAQ)](../c-migration-tool/c-migration-tool.md#section-9681baa01b8c41cdb9659b73b70b50ff)
* [Funzioni di Analytics non supportate nell’Admin Console](../c-migration-tool/c-migration-tool.md#section-928ffba27a0446e0af575b720434ef56)
* [Come avvisare gli utenti riguardo alla migrazione](../c-migration-tool/c-migration-tool.md#section-f3b25f672a3a4d03b0559656fd99d20a)
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sì. Contatta l’<a href="https://helpx.adobe.com/marketing-cloud/contact-support.html" format="html" scope="external">Assistenza clienti di Adobe</a>. </p> 
    <draft-comment> 
     <p>Vedi di seguito per una descrizione delle modifiche apportate alla gestione corrente di Utenti e autorizzazioni Analytics nella data iniziale. </p> 
    </draft-comment> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Prima della data di inizio della migrazione, puoi creare gli utenti nell’Admin Console o in Analytics &gt; Gestione utente. </p> <p>Dopo l’inizio della migrazione, puoi creare utenti e gruppi di autorizzazioni solo nell’Admin Console. </p> 
    <draft-comment> 
     <p>consulta la sezione Migrazione di seguito per ulteriori dettagli su cosa accade nella data di inizio della migrazione. </p> 
    </draft-comment> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sì. Puoi modificare l’iscrizione al gruppo degli utenti non trasferiti dalla sezione Gestione utente di Analytics. </p> 
    <draft-comment> 
     <p>In attesa di chiarimenti da Ashok su dove è stato fatto. </p> 
    </draft-comment> </td> 
  </tr> 
  <tr> 
...
>[!IMPORTANT]
>
>Verifica i seguenti problemi che possono verificarsi durante la migrazione.
...
<table id="table_88E2FA03D5F241B79AB54D12F64B51DA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Gli amministratori che eseguono la migrazione all’Admin Console devono configurare <a href="https://www.adobe.io/apis/cloudplatform/usermanagement/docs/gettingstarted.html" format="html" scope="external">le API di gestione utenti</a> offerte in Adobe I/O per l’accesso programmatico agli account utente nell’Admin Console. </p> <p>Le API delle autorizzazioni di Analytics vengono disattivate quando l’utente è abilitato per la migrazione. </p> </td> 
  </tr> 
  <tr> 
...
Per inviare tutti gli utenti tramite e-mail, passa **[!UICONTROL Analytics]** a &gt; **[!UICONTROL Admin]** &gt; **[!UICONTROL User Management]** &gt; Invia [per e-mail.](https://marketing.adobe.com/resources/help/en_US/reference/t_email_users.html)
