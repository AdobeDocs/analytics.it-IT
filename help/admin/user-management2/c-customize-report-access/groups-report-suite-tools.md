...
| [Personalizzazione menu](/help/admin/admin/customize-menus.md) | Personalizzate i menu dei rapporti che un utente vede in Reporting e  Analytics. |
| [Configurazione report in tempo reale](/help/admin/admin/realtime/t-realtime-admin.md) | Autorizzazioni per l&#39;impostazione di rapporti in tempo reale  Analytics. |
...
| [Gerarchie classificazione](/help/components/classifications/classification-hierarchies.md) | Consolidato in Classificazioni (in Strumenti e Rapporti). |
...
| Gestione feed dati | Concede i diritti al feed di dati Analytics . |
