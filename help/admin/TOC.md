...
product: analytics
audience: admin
user-guide-title: Guida all'amministrazione di Analytics
...
+ [Aiuto di Analytics Admin](home.md)
+ Analytics Admin overview {#admin-overview}
   + [Quale strumento Adobe Analytics devo usare?](c-analytics-product-comparison/which-analytics-tool.md)
...
+ Strumenti di amministrazione {#admin-tools}
   ...
   + Regole bot {#bot-rules}
      + [Panoramica delle regole bot](admin/bot-rules/bot-rules.md)
      + [Caricare regole bot](admin/bot-rules/t-upload-bot-rules.md)
      + [Creare una regola bot personalizzata](admin/bot-rules/t-create-bot-rules.md)
   ...
   + Conversion Variables {#conversion-variables}
      ...
      + [Classificazioni conversione](admin/conversion-var-admin/conversion-classifications.md)
   + [Codici valuta](admin/currency.md)
   + [Descrizioni report personalizzate](admin/custom-desc-admin.md)
   ...
   + [Impostazioni account generale](admin/general-acct-settings-admin.md)
   ...
   + Paid Search Detection {#paid-search-detection}
      + [Panoramica sul rilevamento di ricerche a pagamento](admin/paid-search-detection/paid-search-detection.md)
      + [Configurazione del rilevamento delle ricerche a pagamento](admin/paid-search-detection/t-paid-search-detection.md)
   ...
   + [Impostazioni della privacy](admin/privacy-settings.md)
   + Regole di elaborazione {#processing-rules}
      ...
      + Processing rules examples {#processing-rules-examples}
         ...
         + [Compilazione di termini di ricerca interni utilizzando un parametro di stringa query](admin/c-processing-rules/processing-rules-examples/processing-rules-populating-internal-search.md)
         ...
         + [Rimozione di un evento da un hit](admin/c-processing-rules/processing-rules-examples/processing-rules-remove-event.md)
   ...
   + Rapporti in tempo reale {#real-time-reports}
      + [Panoramica sui report in tempo reale](admin/realtime/realtime.md)
      + [Configurazione dei report in tempo reale](admin/realtime/t-realtime-admin.md)
   ...
   + Traffic variables {#traffic-variables}
      ...
      + [Abilitare i rapporti sulle variabili del traffico](admin/c-traffic-variables/t-traffic-variable.md)
...
+ Experience Cloud Admin Console {#admin-console}
   ...
   + Permissions {#permissions}
      ...
      + [Autorizzazioni degli strumenti di suite di rapporti](admin-console/permissions/report-suite-tools.md)
      + [Autorizzazioni di Analytics Tools](admin-console/permissions/analytics-tools.md)
...
+ Company Settings {#company-settings}
   ...
   + [Livelli di accesso alle funzioni](company/feature-access-levels.md)
   + [Servizi web](company/web-services-admin.md)
   + [Report del Generatore di report](company/report-builder-reports-admin.md)
...
+ Manage report suites {#manage-report-suites}
   ...
   + Report suite templates {#report-suite-templates}
      ...
      + [Supporto supporto](c-manage-report-suites/c-report-suite-templates/support-media.md)
   ...
   + New report suite {#new-report-suite}
      ...
      + [Impostazioni non copiate da una suite di rapporti sorgente](c-manage-report-suites/c-new-report-suite/settings-not-copied-from-rs.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + [Assegnazione di gruppi di utenti a una suite di rapporti](user-management2/t-group-access-report-suite.md)
   ...
   + [Invia per e-mail gli utenti](user-management2/t-email-users.md)
+ Data Governance {#data-governance}
   + [Adobe Analytics e RGPD](c-data-governance/an-gdpr-overview.md)
   + [Domande frequenti](c-data-governance/gdpr-faq.md)
   + [Flusso di lavoro GDPR di Adobe Analytics](c-data-governance/an-gdpr-workflow.md)
   + [Visualizzare/gestire le impostazioni di governance dati della suite di rapporti](c-data-governance/gdpr-view-settings.md)
   + [Etichettare i dati delle suite di rapporti](c-data-governance/gdpr-setup-reportsuite.md)
   + [Invio di richieste di accesso ed eliminazione](c-data-governance/gdpr-submit-access-delete.md)
   + [Etichette GDPR per variabili Analytics](c-data-governance/gdpr-labels.md)
   + [Namespace](c-data-governance/gdpr-namespaces.md)
   + [Espansione ID](c-data-governance/gdpr-id-expansion.md)
   + [Best practice di etichettatura](c-data-governance/gdpr-analytics-ids.md)
   + [Esempio di etichettatura](c-data-governance/gdpr-labeling-example.md)
...
+ Traffic Management {#traffic-management}
   ...
   + [Stima le chiamate server passate e pianifica un picco di traffico](c-traffic-management/traffic-spike-estimate-past-server-calls.md)
   + [Specifica aumento traffico permanente](c-traffic-management/t-traffic-permanent.md)
   + [Tempo di lead richiesto per aumentare il traffico](c-traffic-management/traffic-lead-time.md)
+ [API amministratore](c-admin-api/c-admin-api.md)
