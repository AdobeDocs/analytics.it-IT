...
+ Strumenti di amministrazione di Analytics {#admin-tools}
   ...
   + [Inventario di Analytics](admin/analytics-inventory.md)
      ...
      + Modificare le impostazioni di una suite di rapporti {#edit-report-suite}
         + Generale {#report-suite-general}
            ...
            + Regole di elaborazione {#processing-rules}
               + [Panoramica](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-overview.md)
               + [Interfaccia](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-interface.md)
               + [Visualizza cronologia](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-view-history.md)
               + [Copia regole](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-copy.md)
               + [Dimensioni e metriche disponibili](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-variables.md)
               + [Casi d’uso](admin/c-manage-report-suites/c-edit-report-suites/general/processing-rules/pr-use-cases.md)
            ...
            + Inoltro lato server {#server-side-forwarding}
               ...
               + [Conformità a GDPR/ePrivacy e inoltro lato server](admin/c-manage-report-suites/c-edit-report-suites/general/c-server-side-forwarding/ssf-gdpr.md)
