...
| **Passaggio 3**: Acquisisci familiarità con etichette DULE/Data Privacy, ID Adobe Analytics, spazi dei nomi ed espansione ID. | Leggi questi argomenti nella presente documentazione:<ul><li>[Etichette sulla privacy dei dati per le variabili Analytics](/help/admin/c-data-governance/gdpr-labels.md)</li><li>[Tecniche di etichettatura consigliate](/help/admin/c-data-governance/gdpr-analytics-ids.md)</li></ul> |
