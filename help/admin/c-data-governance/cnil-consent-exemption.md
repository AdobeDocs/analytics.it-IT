...
* Limite dei cookie a 13 mesi impostato su una data statica, non su base continua.  Puoi modificare la scadenza dei cookie di analisi utilizzando la variabile `cookieLifetime`.   [cookieLifetime](https://experienceleague.adobe.com/docs/analytics/implementation/vars/config-vars/cookielifetime.html?lang=it)
