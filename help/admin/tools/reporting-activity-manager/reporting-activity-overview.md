...
![autorizzazione](/help/admin/tools/assets/rep-mgr-permission.png)

## Visualizzare l’attività di reporting

Per informazioni sulla visualizzazione delle attività di reporting in Reporting Activity Manager, consulta [Visualizzare le attività di reporting in Reporting Activity Manager](/help/admin/tools/reporting-activity-manager/reporting-activity.md).

## Annullare le richieste di reporting

Per informazioni sull’annullamento delle richieste di reporting in Reporting Activity Manager, consulta [Annulla le richieste di reporting in Reporting Activity Manager](/help/admin/tools/reporting-activity-manager/reporting-activity-cancel-requests.md).
