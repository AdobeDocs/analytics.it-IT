...
Consulta ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Configurazione delle impostazioni account generali](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-general-account-settings){target="_blank"} per un video dimostrativo.
