...
>[!NOTE]
>
>Adobe Experience Platform Edge Network fornisce un [servizio di rilevamento bot](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html?lang=it) che etichetta gli hit identificati come provenienti da bot. Il processo di rilevamento dei bot utilizzato in Adobe Analytics è separato e non fa riferimento al punteggio dei bot incluso nei dati in arrivo tramite Edge Network. Tuttavia, i due sistemi utilizzano lo stesso elenco di bot IAB.
...
>[!NOTE]
>
>Gli hit contrassegnati come *`bots`* sono fatturati come [chiamate al server.](/help/admin/tools/server-call-usage/overage-overview.md)
