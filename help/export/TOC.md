...
user-guide-url: /content/help/it-IT/analytics/export/home.html
translation-type: ht
...
+ Feed dati di Analytics {#analytics-data-feed}
   + introduzione {#get-started}
      + [Panoramica sui feed dati di Analytics](analytics-data-feed/c-getstarted/data-feed-overview.md)
      + [Terminologia](analytics-data-feed/c-getstarted/datafeeds-terminology.md)
      + [Procedure consigliate e informazioni generali](analytics-data-feed/c-getstarted/data-feeds-best-practices.md)
   + Interfaccia feed dati {#data-feed-ui}
   ...
   + Azioni Feed dati {#data-feed-actions}
      ...
      + [Visualizzare la cronologia dei processi di un feed](analytics-data-feed/c-data-feed-actions/t-feed-job-history.md)
   ...
   + Processi feed dati {#data-feed-jobs}
      + [Processi feed dati: panoramica](analytics-data-feed/c-df-jobs/feed-jobs-processing.md)
      + [Filtra elenco processi](analytics-data-feed/c-df-jobs/t-jobs-filter.md)
   ...
   + Contenuti feed dati {#data-feed-contents}
      + [Contenuti feed dati: panoramica](analytics-data-feed/c-df-contents/datafeeds-contents.md)
      ...
      + [Ricerca origine occorrenza](analytics-data-feed/c-df-contents/datafeeds-hit-source.md)
