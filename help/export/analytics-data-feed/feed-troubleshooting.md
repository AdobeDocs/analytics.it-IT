...
Quando si creano transizioni DST -> STD, (&quot;Autunno Indietro&quot;), il cliente riceve 24 file. Tuttavia, l&#39;ora della transizione includerà in realtà due ore di dati. Ad esempio, se la transizione si verifica alle 2:00 del mattino, il file per 1:00 verrà ritardato di un&#39;ora, ma conterrà i dati per due ore. Conterrà dati da 1:00 DST a 2:00 STD (che sarebbe stato 3:00 DST). Il file successivo inizierà alle 2:00 STD.
