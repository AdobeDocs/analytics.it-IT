...
[Convalida l&#39;implementazione di Analytics e pubblica in produzione](../launch/validate-publish-prod.md). Anche se non è richiesta direttamente, Adobe consiglia di implementare un&#39;implementazione di base che consenta la raccolta dei dati critici e la definizione e l&#39;implementazione di requisiti aziendali aggiuntivi.
...
1. **Mappare dimensioni e metriche in una pagina o in un foglio di calcolo.** Questa pagina o tabella diventa il documento di progettazione della soluzione. Alcune colonne o punti elenco utili da includere:
   ...
   * Variabile di Analytics mappata a: la variabile di Analytics predefinita o personalizzata a cui scegli di assegnare i valori. Le dimensioni in genere rientrano nelle eVar, mentre le metriche rientrano negli eventi.
...
Ci sono anche diversi partner Adobe specializzati nell’assistenza per la creazione di un documento di progettazione della soluzione e nell’implementazione di Adobe Analytics sul sito.
