...
seo-title: Roadmap implementazione
...
<table id="table_1683413EA0E34DBC9291832647B68E96"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col1"> Scegliete un metodo di implementazione. </td> 
   <td colname="col2"> <p>Metodi comuni per implementare Analytics includono: </p> <p> 
     <ul id="ul_A7475867861540EFBD77AEE8C6DAD418"> 
      <li id="li_035E2619670F4D04A7F708625A9C01EF"> <a href="https://docs.adobelaunch.com/" format="https" scope="external"> Lancio </a> della piattaforma Experience (consigliato) <p>Questa guida ti dirà tutto ciò che ti serve per sapere quali sono le informazioni sull'utilizzo delle funzionalità di gestione dei tag e degli SDK per dispositivi mobili di Adobe e come implementarli. </p> </li> 
      <li id="li_996FA2F5B0E149399CED391AB5235D8A"> <a href="../../implement/c-implement-with-dtm/dtm-implementation-overview.md" format="dita" scope="local"> Dynamic Tag Management </a> <p>Questa guida contiene informazioni specifiche di Analytics per guidarti attraverso un'implementazione Gestione tag dinamica. </p> </li> 
 ...
 = = = = = = = = = = = = = = NON MODIFICATE NULLA sotto questa riga. = = = = = = = = = = = = </code>  
  ...
  <tr> 
   ...
   <td colname="col1"> Utilizzate il metodo di implementazione scelto per aggiornare e distribuire il codice della pagina. </td> 
   <td colname="col2"> <p>Place the page code just after the opening <code> &lt;body&gt; </code> tag on each page you want to track. Come minimo, aggiorna le seguenti variabili: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="../../implement/impl-testing/impl-validation/impl-validation.md" format="dita" scope="local"> Test e convalida </a> Fornisce informazioni sulla convalida della propria implementazione. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <img  src="assets/step5_icon.png" id="image_844E896941E2489A943BE10AD710ED36" /> </td> 
   <td colname="col1"> Utilizza il debugger di Adobe Experience Cloud per verificare che i dati siano in corso di invio. </td> 
   <td colname="col2"> <p>Install the <a href="../../implement/impl-testing/debugger.md#topic_E05CEAF0682E483A9AB147D774CF2188" format="dita" scope="local"> Experience Cloud Debugger </a>. Dopo essere stato installato, caricate una pagina in cui avete distribuito il codice della pagina e aprite il debugger. Il debugger visualizza i dettagli relativi ai dati della raccolta inviati. </p> </td> 
  </tr> 
 </tbody> 
</table>
