...
| `bh` | None | Altezza browser (in pixel). Utilizzata nella dimensione [Altezza browser](/help/components/dimensions/browser-height.md). |
| `bw` | None | Larghezza browser (in pixel). Utilizzata nella dimensione [Larghezza browser](/help/components/dimensions/browser-width.md). |
| `c` | None | Qualità del colore (in bit). Utilizzata nella dimensione [Profondità colore](/help/components/dimensions/color-depth.md). |
...
| `ch` | [`channel`](../vars/page-vars/channel.md) | Utilizzata nella dimensione [Sezioni del sito](/help/components/dimensions/site-section.md). |
| `cp` | None | Utilizzato nella dimensione [Hit Type](/help/components/dimensions/hit-type.md). |
| `ct` | None | Utilizzato nella dimensione [Tipo di connessione](/help/components/dimensions/connection-type.md). |
...
| `g` | [`pageURL`](../vars/page-vars/pageurl.md) | L&#39;URL corrente della pagina, fino a 255 byte. Utilizzata nella dimensione [URL pagina](/help/components/dimensions/page-url.md). |
...
| `pageName` | [`pageName`](../vars/page-vars/pagename.md) | Utilizzata nella dimensione [Page](/help/components/dimensions/page.md). |
...
| `r` | [`referrer`](../vars/page-vars/referrer.md) | URL di riferimento dell’hit. Utilizzato nelle dimensioni delle origini di traffico, come [Referente](/help/components/dimensions/referrer.md) e [Dominio di riferimento](/help/components/dimensions/referring-domain.md) |
| `s` | None | Risoluzione dello schermo, in `width x height`. Utilizzata nella dimensione [risoluzioni monitor](/help/components/dimensions/monitor-resolution.md). |
| `server` | [`server`](../vars/page-vars/server.md) | [](/help/components/dimensions/server.md) Serversize. |
...
| `v` | None | Utilizzata nella dimensione [Java enabled](/help/components/dimensions/java-enabled.md). |
| `v0` | [`campaign`](../vars/page-vars/campaign.md) | [Tracciamento ](/help/components/dimensions/tracking-code.md) della dimensione del codice. |
...
| `zip` | [`zip`](../vars/page-vars/zip.md) | Utilizzato nella dimensione [Codice ZIP](/help/components/dimensions/zip-code.md). |
