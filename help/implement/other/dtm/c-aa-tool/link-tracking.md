...
<table id="table_F23FB0B284E74B66A107B1D69D22A51C">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Determina se i dati della mappa clic visitatore vengono raccolti. </p> <p>Vedere [trackInlinestats](../../../vars/config-vars/trackinlinestats.md). </p> </td>
  </tr>
  <tr>
   <td colname="col1"> Traccia collegamenti di download </td>
   <td colname="col2"> <p>Tiene traccia dei collegamenti verso file scaricabili sul sito. </p> <p>Consultate [trackDownloadLinks](../../../vars/config-vars/trackdownloadlinks.md).</p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> Download delle estensioni </td> 
   <td colname="col2"> <p>Se il sito contiene collegamenti a file con una delle estensioni elencate, gli URL di questi collegamenti verranno visualizzati nei rapporti. </p>Consultate [linkDownloadFileTypes](../../../vars/config-vars/linkdownloadfiletypes.md). </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> Traccia collegamenti in uscita </td>
   <td colname="col2"> <p>Determina se un collegamento su cui è stato fatto clic è un collegamento di uscita. </p> <p>Consultate [trackExternalLinks](../../../vars/config-vars/trackexternallinks.md). </p> <p><b>Considerazioni sulle app su una sola pagina (SPA):</b> a seconda del modo in cui alcuni siti Web SPA sono codificati, un collegamento interno a una pagina del sito SPA potrebbe sembrare un collegamento in uscita. </p> <p>Puoi usare uno dei seguenti metodi per tenere traccia dei collegamenti in uscita dai siti SPA: </p>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Mantiene le stringhe di query. </p> <p>Vedere [linkLeftQueryString](../../../vars/config-vars/linkleavequerystring.md). </p> </td>
  </tr>
 </tbody>
</table>
