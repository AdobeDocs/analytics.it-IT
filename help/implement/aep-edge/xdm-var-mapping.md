...
| `xdm.media.mediaTimed.firstQuartiles.value` | La metrica per contenuti multimediali in streaming [Indicatore di avanzamento al 25%](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#twenty-five-progress-marker). |
| `xdm.media.mediaTimed.mediaSegmentView.value` | La metrica per contenuti multimediali in streaming [Visualizzazioni dei segmenti di contenuto](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-segment-views). |
| `xdm.media.mediaTimed.midpoints.value` | La metrica per contenuti multimediali in streaming [Indicatore di avanzamento al 50%](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#fifty-progress-marker). |
...
| `xdm.media.mediaTimed.pauses.value` | La metrica per contenuti multimediali in streaming [Eventi di pausa](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#pause-events). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`@id` | La dimensione dei contenuti multimediali in streaming [ID risorsa](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#asset-id). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`dc:title` | La dimensione dei contenuti multimediali in streaming [Nome video](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#video-name). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Creator[N].iptc4xmpExt:Name` | La dimensione dei contenuti multimediali in streaming [Iniziatore](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#originator). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Episode.iptc4xmpExt:Number` | La dimensione dei contenuti multimediali in streaming [Episodio](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#episode). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Genre` | La dimensione dei contenuti multimediali in streaming [Genere](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#genre). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Rating[N].iptc4xmpExt:RatingValue` | La dimensione dei contenuti multimediali in streaming [Valutazione dei contenuti](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-rating). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Season.iptc4xmpExt:Number` | La dimensione dei contenuti multimediali in streaming [Stagione](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#season). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Series.iptc4xmpExt:Identifier` | La dimensione dei contenuti multimediali in streaming [ID contenuto](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-id). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`iptc4xmpExt:Series.iptc4xmpExt:Name` | La dimensione dei contenuti multimediali in streaming [Spettacolo](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#show). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`showType` | La dimensione dei contenuti multimediali in streaming [Tipo di spettacolo](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#show-type). |
| `xdm.media.mediaTimed.primaryAssetReference.`<br/>`xmpDM:duration` | La dimensione dei contenuti multimediali in streaming [Lunghezza video](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#video-length). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`@id` | La dimensione dei contenuti multimediali in streaming [ID sessione multimediale](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#media-session-id). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`broadcastChannel` | La dimensione dei contenuti multimediali in streaming [Canale contenuto](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-channel). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`broadcastContentType` | La dimensione dei contenuti multimediali in streaming [Tipo di contenuto](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-type). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`broadcastNetwork` | La dimensione dei contenuti multimediali in streaming [Rete](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#network). |
...
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`playerName` | La dimensione dei contenuti multimediali in streaming [Nome del lettore di contenuti](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-player-name). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`playerSDKVersion.version` | La dimensione dei contenuti multimediali in streaming [SDK min.](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#sdk-version). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`sourceFeed` | La dimensione dei contenuti multimediali in streaming [Tipo di feed multimediale](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#media-feed-type). |
| `xdm.media.mediaTimed.primaryAssetViewDetails.`<br/>`streamFormat` | La dimensione dei contenuti multimediali in streaming [Formato flusso](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#stream-format). |
...
| `xdm.media.mediaTimed.progress95.value` | La metrica per contenuti multimediali in streaming [Indicatore di avanzamento al 95%](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#ninety-five-progress-marker). |
| `xdm.media.mediaTimed.resumes.value` | La metrica per contenuti multimediali in streaming [Riprende il contenuto](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-resumes). |
| `xdm.media.mediaTimed.starts.value` | La metrica per contenuti multimediali in streaming [Avvio file multimediale](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#media-starts). |
| `xdm.media.mediaTimed.thirdQuartiles.value` | La metrica per contenuti multimediali in streaming [Indicatore di avanzamento al 75%](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#seventy-five-progress-marker). |
| `xdm.media.mediaTimed.timePlayed.value` | La metrica per contenuti multimediali in streaming [Tempo trascorso dei contenuti](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#content-time-spent). |
| `xdm.media.mediaTimed.totalTimePlayed.value` | La metrica per contenuti multimediali in streaming [Tempo trascorso contenuti multimediali](https://experienceleague.adobe.com/docs/media-analytics/using/metrics-and-metadata/audio-video-parameters.html?lang=it#media-time-spent). |
