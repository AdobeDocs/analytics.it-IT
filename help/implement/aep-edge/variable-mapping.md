...
| `_experience.analytics.customDimensions.`<br/>`hierarchies.hier1` -<br/>`_experience.analytics.customDImensions.`<br/>`hierarchies.hier5` | Imposta i rispettivi [Gerarchia](/help/components/dimensions/hierarchy.md) dimensione. |
