...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list` | Imposta la rispettiva [Variabile elenco](../vars/page-vars/list.md). |
