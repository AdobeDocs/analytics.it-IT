...
* **JavaScript legacy:** metodo manuale che veniva utilizzato per implementare Adobe Analytics. Fai riferimento alla libreria AppMeasurement (`AppMeasurement.js`) in ogni pagina e quindi delle variabili di struttura e delle impostazioni utilizzate in un’implementazione.
