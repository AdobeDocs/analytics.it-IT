...
Il plug-in `addProductEvar` non restituisce alcun risultato. Aggiunge invece alla variabile `products` l&#39;eVar (e il valore dell&#39;eVar) specificati negli argomenti `en` e `ev`.
