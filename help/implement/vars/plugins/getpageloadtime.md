...
>[!IMPORTANT]
>
>Questo plug-in non è più supportato. Il suo codice utilizza il metodo performance.timing, che (secondo MDN) è stato [obsoleto](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceTiming).
