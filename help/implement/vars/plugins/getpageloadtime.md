...
* `s_pltp` Il valore della `s.pageName` variabile come registrato nella precedente richiesta di immagine di Adobe Analytics. Scade alla fine della sessione del browser.
