...
La funzione `getPageLoadTime` non utilizza argomenti. Quando si chiama questa funzione, non restituisce alcun risultato. Imposta invece le seguenti variabili:
