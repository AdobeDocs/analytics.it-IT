...
Prima del [Servizio Adobe Experience Cloud Identity](https://experienceleague.adobe.com/en/docs/id-service/using/home), questa variabile determinava anche dove venivano impostati i cookie di terze parti. Adobe consiglia vivamente di utilizzare il servizio ID in tutte le implementazioni, laddove possibile.
...
* Se hai implementato e configurato correttamente il servizio [Adobe Experience Cloud Identity](https://experienceleague.adobe.com/en/docs/id-service/using/home)
...
* Le implementazioni manuali di AppMeasurement utilizzano `VisitorAPI.js` e chiamano il metodo `getInstance`. Per ulteriori informazioni, consulta [Implementazione del servizio Experience Cloud Identity per Analytics](https://experienceleague.adobe.com/en/docs/id-service/using/implementation/setup-analytics).
