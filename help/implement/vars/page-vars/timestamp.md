...
La variabile `s.timestamp` è una stringa contenente la data e l&#39;ora dell&#39;hit. I formati di marca temporale validi includono [ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) e [Tempo Unix](https://en.wikipedia.org/wiki/Unix_time) in secondi.
...
Le date e le ore espresse in [ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) possono assumere diverse forme. Adobe non supporta tutte le funzioni di ISO 8601.
...
* La data può essere in formato standard o esteso. Ad esempio, `2026-01-01T00:00:00Z` e `20260101T000000Z` sono entrambi validi.
* I minuti e i secondi frazionari sono tecnicamente validi, ma le frazioni vengono ignorate. Adobe Analytics supporta le marche temporali solo con precisione di secondo livello. Se la precisione a livello di millisecondi è una priorità per la tua organizzazione, puoi utilizzare Customer Journey Analytics.
