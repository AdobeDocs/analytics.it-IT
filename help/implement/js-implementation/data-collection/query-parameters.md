...
Nelle tabelle seguenti è riportato il parametro di query che contiene il valore per ogni variabile di analisi inviata alla raccolta dati.

Queste informazioni possono essere utilizzate per il debug con [Packet Analytics](../../../implement/impl-testing/packet-monitor.md#concept_490DF35E06D44234A91B5FC57C0BF258), per la creazione manuale di richieste di immagini o per l'utilizzo di variabili [](../../../implement/js-implementation/c-variables/dynvars-overview.md#concept_B016789733A94070A9EAB209EEC05262)dinamiche.

<table id="table_5442E15BF0AE4BDA92DDADD1C08F7C13"> 
 <thead> 
  <tr> 
   <th class="entry"> Parametro </th> 
   <th class="entry"> Variabile di Analytics </th> 
   <th class="entry"> Report compilato </th> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col4"> Suggerimento sulla posizione di Audience Manager (utilizzato nell'integrazione dei profili condivisi di Experience Cloud) </td> 
  </tr> 
  <tr> 
   <td colname="col1"> aambo </td> 
   <td colname="col2"> Nessuno </td> 
   <td colname="col3"> Nessuno </td> 
   <td colname="col4"> Blob di Audience Manager (utilizzato nell'integrazione del profilo condiviso di Experience Cloud) </td> 
  </tr> 
  <tr> 
