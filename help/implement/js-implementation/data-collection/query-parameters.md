...
Queste informazioni possono essere utilizzate per il debug con [Packet Analytics](/help/implement/impl-testing/packet-monitor.md), per la creazione manuale di richieste di immagini o per l'utilizzo di variabili [](/help/implement/js-implementation/c-variables/dynvars-overview.md)dinamiche.
