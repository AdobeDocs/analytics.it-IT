...
git-repo: https://git.corp.adobe.com/AdobeDocs/analytics.it-IT
type: Documentazione
index: true
description: Include i metadati a livello di repository che passano ai file TOC.md della guida utente nel repository.
